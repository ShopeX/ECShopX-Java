...
/**
 * {@link AliyunsmsGetSmsTemplateClient} 的 Noop；test-cron 下替代真实 Dysms 调用。默认不返回 templateStatus，避免误写库。
 */
@Slf4j
public class NoopAliyunsmsGetSmsTemplateClient implements AliyunsmsGetSmsTemplateClient {
	...
	public GetSmsTemplateResult getSmsTemplate(long companyId, String templateCode) {
		...
		log.info("[cron-mock][aliyunsms-get-sms-template] called#{}, args={}", n, Arrays.toString(new Object[] { companyId, templateCode }));
