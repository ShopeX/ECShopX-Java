...
@Slf4j
public class NoopAdminOrderDetailSalespersonLookupPort implements AdminOrderDetailSalespersonLookupPort {
	...
	public Map<String, Object> loadSalespersonForOrderDetail(long companyId, long salespersonId) {
		...
		log.info(
				"[cron-mock][getaftersales-read-salesperson] called#{}, args={}",
				n,
				Arrays.toString(new Object[] {companyId, salespersonId}));
