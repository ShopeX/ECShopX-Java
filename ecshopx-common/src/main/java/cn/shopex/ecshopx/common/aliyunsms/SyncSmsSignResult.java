...
public class SyncSmsSignResult {
	...
	private int skipped;
	private int failed;
	private final List<SyncSmsSignError> errors = new ArrayList<>();
	...
	public List<SyncSmsSignError> errors() { return List.copyOf(errors); }
	...
	public void addError(String signName, String message) { errors.add(new SyncSmsSignError(signName, message)); }

	public record SyncSmsSignError(String signName, String message) {}
}
