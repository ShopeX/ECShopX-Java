...
@Slf4j
public class NoopOrderNormalOrderServiceOrderDataReadPort implements OrderNormalOrderServiceOrderDataReadPort {
	...
	public Optional<Map<String, Object>> getServiceOrderData(long companyId, long orderId) {
		...
		log.info(
				"[cron-mock][getaftersales-read-service-order-data] called#{}, args={}",
				n,
