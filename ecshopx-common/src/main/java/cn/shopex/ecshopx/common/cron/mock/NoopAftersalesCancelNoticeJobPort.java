...
@Slf4j
public class NoopAftersalesCancelNoticeJobPort implements AftersalesCancelNoticeJobPort {
	...
	public void scheduleSendAftersaleCancelNotice(long companyId, long aftersalesBn) {
		...
		log.info(
				"[cron-mock][aftersale-cancel-notice] called#{}, args={}",
				n,
				Arrays.toString(new Object[] {companyId, aftersalesBn}));
	}
}
