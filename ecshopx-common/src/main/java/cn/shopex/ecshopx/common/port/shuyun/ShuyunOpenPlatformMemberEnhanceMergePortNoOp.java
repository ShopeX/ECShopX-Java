...
/** 默认空实现；有开放平台 MemberEnhanceMergeService（@Primary）时优先生效。 */
@Component
public class ShuyunOpenPlatformMemberEnhanceMergePortNoOp
		implements ShuyunOpenPlatformMemberEnhanceMergePort {
