...
/**
 * 阶段 4 对拍；alias 与 plan §4 {@code wxapp-datacube-visit-page} 一致。
 */
@Slf4j
public class NoopWxappDataCubeVisitPagePort implements WxappDataCubeVisitPagePort {
	...
	public JsonNode postVisitPage(String wxaAppId, String beginYmd, String endYmd) {
		...
		log.info(
				"[cron-mock][wxapp-datacube-visit-page] called#{}, args={}",
				n,
