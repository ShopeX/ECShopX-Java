...
/**
 * 阶段 4 对拍；alias 与 plan §4 {@code youshu-analysis-wxapp-visit-distribution} 一致。
 */
@Slf4j
public class NoopYoushuAnalysisAddWxappVisitDistributionPort
	...
	public void addWxappVisitDistribution(
		...
		log.info(
				"[cron-mock][youshu-analysis-wxapp-visit-distribution] called#{}, args={}",
				n,
