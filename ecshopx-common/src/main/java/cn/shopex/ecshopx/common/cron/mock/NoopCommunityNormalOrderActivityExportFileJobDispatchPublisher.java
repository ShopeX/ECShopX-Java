...
@Slf4j
public class NoopCommunityNormalOrderActivityExportFileJobDispatchPublisher
	...
	public void publish(
		...
		log.info(
				"[cron-mock][community-normal-order-activity-export-file-job] called#{}, companyId={}, operatorId={},"
						+ " datapassAllowed={}, optionalActivityId={}, queryPresent={}",
				n,
				companyId,
				operatorId,
				datapassAllowed,
