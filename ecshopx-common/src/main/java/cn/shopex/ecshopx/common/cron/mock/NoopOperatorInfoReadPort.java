...
@Slf4j
public class NoopOperatorInfoReadPort implements OperatorInfoReadPort {
	...
	public Map<String, Object> getInfo(long companyId, long operatorId, String operatorType) {
		...
		log.info(
				"[cron-mock][operator-info-read] called#{}, args={}",
				n,
				Arrays.toString(new Object[] {companyId, operatorId, operatorType}));
