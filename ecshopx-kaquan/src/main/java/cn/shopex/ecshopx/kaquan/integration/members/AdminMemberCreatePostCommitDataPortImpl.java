...
@Service("adminMemberCreatePostCommitDataPortImpl")
public class AdminMemberCreatePostCommitDataPortImpl implements AdminMemberCreatePostCommitDataPort {
	...
	public AdminMemberCreatePostCommitDataPortImpl(
	...
	@Override
	public Map<String, Object> loadGradeInfo(long companyId, long gradeId) {
		return memberCardGradeSingleRowQueryService.loadForAdmin(companyId, gradeId, "zh-CN");
	}

	@Override
	public Map<String, Object> loadVipGrade(long companyId, long userId) {
		return vipGradeUserVipGradeGetService.userVipGradeGet(companyId, userId, false);
	}
}
