...
@Service
public class AdminMemberExportUserVipGradePortImpl implements AdminMemberExportUserVipGradePort {

	private final VipGradeUserVipGradeGetService vipGradeUserVipGradeGetService;

	public AdminMemberExportUserVipGradePortImpl(VipGradeUserVipGradeGetService vipGradeUserVipGradeGetService) {
