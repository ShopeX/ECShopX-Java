...
@Component
public class EmployeeUserSyncPublisher {

	private final EmployeeJobDispatchPublisher employeeJobDispatchPublisher;

	public EmployeeUserSyncPublisher(EmployeeJobDispatchPublisher employeeJobDispatchPublisher) {
		this.employeeJobDispatchPublisher = employeeJobDispatchPublisher;
	}

	public void publishAfterCommit(Map<String, Object> eventPayload) {
		employeeJobDispatchPublisher.enqueueAfterCommit(eventPayload);
	}
}
