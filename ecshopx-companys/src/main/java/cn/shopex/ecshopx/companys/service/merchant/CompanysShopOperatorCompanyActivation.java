...
@Service
public class CompanysShopOperatorCompanyActivation implements ShopOperatorCompanyActivation {

	private final CompanysActivationService companysActivationService;

	public CompanysShopOperatorCompanyActivation(CompanysActivationService companysActivationService) {
