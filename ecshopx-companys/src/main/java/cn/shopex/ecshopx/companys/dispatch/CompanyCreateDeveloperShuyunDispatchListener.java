...
@Component
public class CompanyCreateDeveloperShuyunDispatchListener implements DispatchListener {

	private final ShuyunOperatorsFacade shuyunOperatorsFacade;

	public CompanyCreateDeveloperShuyunDispatchListener(ShuyunOperatorsFacade shuyunOperatorsFacade) {
	...
	public void onEvent(Map<String, Object> payload) {
		...
		shuyunOperatorsFacade.syncDeveloperConfigurationToShuyun(companyId);
	}
}
