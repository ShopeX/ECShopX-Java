...
@Service
public class CompanysShopOperatorLogsWrite implements ShopOperatorLogsWrite {

	private final OperatorLogsWriteService operatorLogsWriteService;

	public CompanysShopOperatorLogsWrite(OperatorLogsWriteService operatorLogsWriteService) {
		this.operatorLogsWriteService = operatorLogsWriteService;
	}

	@Override
	public void addLogs(Map<String, Object> context) {
		operatorLogsWriteService.addLogs(context);
	}
}
