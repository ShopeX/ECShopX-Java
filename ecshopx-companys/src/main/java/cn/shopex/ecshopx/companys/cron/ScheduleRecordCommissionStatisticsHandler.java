...
public class ScheduleRecordCommissionStatisticsHandler {

	private static final String SHORT = "record-commission-statistics";
	...
	public void execute() {
		...
		try {
			...
			log.info("[cron][record-commission-statistics] done, costMs={}, jobDispatches=2", costMs);
		} catch (Exception e) {
			long costMs = System.currentTimeMillis() - start;
			log.error("[cron][record-commission-statistics] failed, costMs={}", costMs, e);
