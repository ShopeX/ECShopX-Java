...
@Component
public class CompanyCreateOnlineOpenSmsDispatchListener implements DispatchListener {
	...
	public CompanyCreateOnlineOpenSmsDispatchListener(CompanyOnlineOpenNotificationService notificationService) {
	...
	public void onEvent(Map<String, Object> payload) {
		...
		notificationService.sendOpeningSmsIfApplicable(mobile.trim(), activeAt, expiredAt);
	}
