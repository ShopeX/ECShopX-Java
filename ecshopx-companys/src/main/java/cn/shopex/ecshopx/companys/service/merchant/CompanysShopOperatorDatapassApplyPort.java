...
@Service
public class CompanysShopOperatorDatapassApplyPort implements ShopOperatorDatapassApplyPort {

	private final ShopOperatorDatapassApplyService shopOperatorDatapassApplyService;

	public CompanysShopOperatorDatapassApplyPort(ShopOperatorDatapassApplyService shopOperatorDatapassApplyService) {
