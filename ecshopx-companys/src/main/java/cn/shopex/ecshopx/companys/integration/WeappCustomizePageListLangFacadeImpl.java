...
@Service
public class WeappCustomizePageListLangFacadeImpl implements WeappCustomizePageListLangFacade {

	private final CommonLangModReadService commonLangModReadService;

	public WeappCustomizePageListLangFacadeImpl(CommonLangModReadService commonLangModReadService) {
	...
	public void enrichWeappCustomizePageListRows(long companyId, List<Map<String, Object>> rows, String requestLang) {
		commonLangModReadService.enrichWeappCustomizePageListRows(companyId, rows, requestLang);
	}
}
