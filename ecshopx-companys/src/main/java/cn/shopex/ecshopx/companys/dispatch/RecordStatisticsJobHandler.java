...
@Component
public class RecordStatisticsJobHandler implements DispatchHandler {

	private final CompanysStatisticsService companysStatisticsService;

	public RecordStatisticsJobHandler(CompanysStatisticsService companysStatisticsService) {
		this.companysStatisticsService = companysStatisticsService;
	}

	@Override
	public void handle(Map<String, Object> payload) {
		companysStatisticsService.runCompanyRecordStatisticsBlockForYesterday();
	}
}
