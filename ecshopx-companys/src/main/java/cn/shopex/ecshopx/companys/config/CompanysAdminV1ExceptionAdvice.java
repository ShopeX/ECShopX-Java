...
@RestControllerAdvice(basePackages = "cn.shopex.ecshopx.companys.api.admin.v1")
@Order(Ordered.HIGHEST_PRECEDENCE)
public class CompanysAdminV1ExceptionAdvice {

	@ExceptionHandler({BadRequestException.class, ResourceException.class})
	public ResponseEntity<Map<String, Object>> handleCompanysAdminBusinessErrors(RuntimeException ex) {
