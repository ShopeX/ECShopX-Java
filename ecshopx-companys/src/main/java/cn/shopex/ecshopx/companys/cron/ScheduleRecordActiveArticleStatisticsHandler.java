...
public class ScheduleRecordActiveArticleStatisticsHandler {

	private static final String SHORT = "record-active-article-statistics";
	...
	public void execute() {
		...
		try {
			...
			log.info("[cron][record-active-article-statistics] done, costMs={}, jobDispatches=2", costMs);
		} catch (Exception e) {
			log.error(
					"[cron][record-active-article-statistics] failed, costMs={}",
