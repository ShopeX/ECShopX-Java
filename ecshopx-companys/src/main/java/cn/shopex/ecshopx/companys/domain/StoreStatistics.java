 ...
 */
@Data
@MpTable(value = "companys_store_statistics", comment = "商城数据统计表", indexes = {@MpIndex(name = "ix_company_id", columns = {"company_id"}), @MpIndex(name = "ix_statistic_type", columns = {"statistic_type"}), @MpIndex(name = "ix_statistic_title", columns = {"statistic_title"}), @MpIndex(name = "ix_add_date", columns = {"add_date"}), @MpIndex(name = "ix_shop_id", columns = {"shop_id"})})
