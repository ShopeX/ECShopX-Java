...
public class ScheduleRecordGiveCouponsStatisticsHandler {

	private static final String SHORT = "record-give-coupons-statistics";
	...
	public void execute() {
		...
		try {
			...
			log.info("[cron][record-give-coupons-statistics] done, costMs={}, jobDispatches=2", costMs);
		} catch (Exception e) {
			long costMs = System.currentTimeMillis() - start;
			log.error(
					"[cron][record-give-coupons-statistics] failed, costMs={}",
					costMs,
					e);
