...
@Component
public class HfpayTradeRecordHfpayProfitSharingDispatchListener implements DispatchListener {

	private final HfpayTradeRecordService hfpayTradeRecordService;

	public HfpayTradeRecordHfpayProfitSharingDispatchListener(HfpayTradeRecordService hfpayTradeRecordService) {
	...
	public void onEvent(Map<String, Object> payload) {
		...
		hfpayTradeRecordService.profit(orderId);
	}
}
