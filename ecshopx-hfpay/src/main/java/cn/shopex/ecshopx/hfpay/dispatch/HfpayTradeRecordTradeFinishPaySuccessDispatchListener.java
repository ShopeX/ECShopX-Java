...
@Component
public class HfpayTradeRecordTradeFinishPaySuccessDispatchListener implements DispatchListener {

	private final HfpayTradeRecordService hfpayTradeRecordService;

	public HfpayTradeRecordTradeFinishPaySuccessDispatchListener(HfpayTradeRecordService hfpayTradeRecordService) {
	...
	public void onEvent(Map<String, Object> payload) {
		...
		hfpayTradeRecordService.paySuccess(orderId);
	}
