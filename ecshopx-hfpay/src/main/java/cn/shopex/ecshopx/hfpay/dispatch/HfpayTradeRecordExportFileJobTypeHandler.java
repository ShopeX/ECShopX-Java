...
@Component
public class HfpayTradeRecordExportFileJobTypeHandler implements ExportFileJobTypeHandler {

	private final HfpayTradeRecordExportFileJobHandler hfpayTradeRecordExportFileJobHandler;

	public HfpayTradeRecordExportFileJobTypeHandler(
			HfpayTradeRecordExportFileJobHandler hfpayTradeRecordExportFileJobHandler) {
		this.hfpayTradeRecordExportFileJobHandler = hfpayTradeRecordExportFileJobHandler;
	}

	@Override
	public String exportType() {
		return HfpayTradeRecordExportFileJobTypes.TYPE_HFPAY_TRADE_RECORD;
	}
	...
	public void handle(Map<String, Object> payload) {
		...
		hfpayTradeRecordExportFileJobHandler.run(companyId, operatorId, filter);
	}
