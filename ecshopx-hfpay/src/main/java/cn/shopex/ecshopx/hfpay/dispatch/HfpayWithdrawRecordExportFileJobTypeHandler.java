...
@Component
public class HfpayWithdrawRecordExportFileJobTypeHandler implements ExportFileJobTypeHandler {

	private final HfpayWithdrawRecordExportFileJobHandler jobHandler;

	public HfpayWithdrawRecordExportFileJobTypeHandler(HfpayWithdrawRecordExportFileJobHandler jobHandler) {
		this.jobHandler = jobHandler;
	}

	@Override
	public String exportType() {
		return HfpayWithdrawRecordExportFileJobTypes.TYPE_HFPAY_WITHDRAW_RECORD;
	}
