...
public final class SupplierGoodsHeaderInfo {
	private SupplierGoodsHeaderInfo() {}
	...
	public static Map<String, UploadHeaderColumnInfo> map() {
		...
		map.put("供应商货号", new UploadHeaderColumnInfo(32, "", false));
		...
		map.put("供应状态", new UploadHeaderColumnInfo(30, "可售，不可售", false));
