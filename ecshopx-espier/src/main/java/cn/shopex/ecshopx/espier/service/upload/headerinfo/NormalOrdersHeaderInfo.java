...
public final class NormalOrdersHeaderInfo {
	private NormalOrdersHeaderInfo() {}
	...
	public static Map<String, UploadHeaderColumnInfo> map() {
		...
		map.put("快递单号", new UploadHeaderColumnInfo(255, "", true));
		map.put("快递公司", new UploadHeaderColumnInfo(255, "", true));
