...
public final class NormalGoodsTagHeaderInfo {
	private NormalGoodsTagHeaderInfo() {}
	...
	public static Map<String, UploadHeaderColumnInfo> map() {
		...
		map.put("标签名称", new UploadHeaderColumnInfo(255, "商品标签为全量覆盖，不填表示清空商品所有标签。多个标签用英文逗号“,”隔开", false));
