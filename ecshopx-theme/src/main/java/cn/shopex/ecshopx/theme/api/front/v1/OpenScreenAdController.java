...
import cn.shopex.ecshopx.theme.service.OpenScreenAdWxappGetInfoService;
...
@RestController("themeFrontV1OpenScreenAd")
@RequestMapping("/api/v1/h5app/wxapp")
public class OpenScreenAdController {

	private final OpenScreenAdWxappGetInfoService openScreenAdWxappGetInfoService;

	@GetMapping(value = "/openscreenad", name = "开屏广告")
	public ApiResult<Object> getInfo(HttpServletRequest request) {
		long companyId = parseCompanyIdFromRequest(request);
		Object payload = openScreenAdWxappGetInfoService.getInfo(companyId);
