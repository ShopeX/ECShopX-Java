...
@Component
public class CreateMemberSuccessShopexCrmSyncDispatchListener implements DispatchListener {

	private final CreateMemberSuccessShopexCrmSyncExecutionService executionService;

	public CreateMemberSuccessShopexCrmSyncDispatchListener(
	...
	public void onEvent(Map<String, Object> payload) {
		executionService.executeAfterCreateMemberSuccess(payload);
	}
}
