...
@Component
public class OrderDeliveryDmCrmOnNormalOrderDeliveryDispatchListener implements DispatchListener {

	private final OrderDeliveryDmCrmOnNormalOrderDeliveryProcessor processor;

	public OrderDeliveryDmCrmOnNormalOrderDeliveryDispatchListener(
