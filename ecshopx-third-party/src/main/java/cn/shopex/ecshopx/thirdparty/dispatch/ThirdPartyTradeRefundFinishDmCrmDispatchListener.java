...
@Component
public class ThirdPartyTradeRefundFinishDmCrmDispatchListener implements DispatchListener {

	private final TradeRefundFinishDmCrmProcessor processor;

	public ThirdPartyTradeRefundFinishDmCrmDispatchListener(TradeRefundFinishDmCrmProcessor processor) {
