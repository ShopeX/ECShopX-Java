...
@Service
public class DistributionAddPushMarketingCenterProcessor {

	private final MarketingCenterOpenApiSignedFormClient marketingCenterOpenApiSignedFormClient;

	public DistributionAddPushMarketingCenterProcessor(
	 ...
	 * {@code basics.distribution.proccess}, mapping keys so the request body aligns with the entities snapshot shape
	...
	public void handle(Map<String, Object> payload) {
		...
		marketingCenterOpenApiSignedFormClient.basicsDistributionProccess(companyId, params);
	}
