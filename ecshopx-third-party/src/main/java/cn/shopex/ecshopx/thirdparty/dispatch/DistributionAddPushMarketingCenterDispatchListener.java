...
@Component
public class DistributionAddPushMarketingCenterDispatchListener implements DispatchListener {

	private final DistributionAddPushMarketingCenterProcessor processor;

	public DistributionAddPushMarketingCenterDispatchListener(DistributionAddPushMarketingCenterProcessor processor) {
