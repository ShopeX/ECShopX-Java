...
@Service
public class CreateMemberSuccessShopexCrmSyncExecutionService {

	private final ShopexCrmSyncSingleMemberPort shopexCrmSyncSingleMemberPort;
	private final String crmCrmSync;

	public CreateMemberSuccessShopexCrmSyncExecutionService(
	...
	public void executeAfterCreateMemberSuccess(Map<String, Object> payload) {
