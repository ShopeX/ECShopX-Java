...
@Service("marketingCenterOperatorSalespersonInfoNoOp")
@ConditionalOnProperty(
		prefix = "ecshopx.thirdparty.marketing-center.operator-salesperson-info",
		name = "http-enabled",
		havingValue = "false",
		matchIfMissing = true)
public class MarketingCenterOperatorSalespersonInfoNoOp implements MarketingCenterOperatorSalespersonInfoPort {
