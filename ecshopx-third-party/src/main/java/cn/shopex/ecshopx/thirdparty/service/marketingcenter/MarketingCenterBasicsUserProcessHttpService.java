...
@Component
public class MarketingCenterBasicsUserProcessHttpService implements MarketingCenterBasicsUserProcessPort {

	private static final String OPEN_API_METHOD = "basics.user.proccess";

	private final MarketingCenterOpenApiSignedFormClient marketingCenterOpenApiSignedFormClient;

	public MarketingCenterBasicsUserProcessHttpService(
	...
	@Override
	public void processUser(long companyId, Map<String, Object> requestPayload) {
		marketingCenterOpenApiSignedFormClient.postReturningParsedDataWithJsonArrayData(
				companyId, OPEN_API_METHOD, List.of(requestPayload));
	}
}
