...
@Component
public class OrderDeliveryPushMarketingCenterOnNormalOrderDeliveryDispatchListener implements DispatchListener {

	private final OrderDeliveryPushMarketingCenterOnNormalOrderDeliveryProcessor processor;

	public OrderDeliveryPushMarketingCenterOnNormalOrderDeliveryDispatchListener(
