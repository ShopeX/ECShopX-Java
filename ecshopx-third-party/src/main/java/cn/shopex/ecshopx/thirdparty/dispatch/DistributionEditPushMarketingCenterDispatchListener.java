...
@Component
public class DistributionEditPushMarketingCenterDispatchListener implements DispatchListener {

	private final DistributionEditPushMarketingCenterProcessor processor;

	public DistributionEditPushMarketingCenterDispatchListener(DistributionEditPushMarketingCenterProcessor processor) {
