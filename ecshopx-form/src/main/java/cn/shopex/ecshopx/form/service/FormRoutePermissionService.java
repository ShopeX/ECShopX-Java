...
@Service
public class FormRoutePermissionService {

	public static final String ROUTE_ALIAS_TRANSCRIPT_CREATE = "transcript.create";

	public static final String ROUTE_ALIAS_TRANSCRIPT_UPDATE = "transcript.update";

	public static final String ROUTE_ALIAS_TRANSCRIPT_DETAIL = "transcript.detail";

	public static final String ROUTE_ALIAS_TRANSCRIPT_DELETE = "transcript.delete";

	public static final String ROUTE_ALIAS_USERTRANSCRIPT_CREATE = "usertranscript.create";

	public static final String ROUTE_ALIAS_USERTRANSCRIPT_LIST = "usertranscript.list";
	...
	public FormRoutePermissionService(
	...
	public void assertTranscriptCreate(Map<String, Object> user) {
		assertRouteAllowed(user, ROUTE_ALIAS_TRANSCRIPT_CREATE);
	}

	public void assertTranscriptUpdate(Map<String, Object> user) {
		assertRouteAllowed(user, ROUTE_ALIAS_TRANSCRIPT_UPDATE);
	}

	public void assertTranscriptDetail(Map<String, Object> user) {
		assertRouteAllowed(user, ROUTE_ALIAS_TRANSCRIPT_DETAIL);
	}

	public void assertTranscriptDelete(Map<String, Object> user) {
		assertRouteAllowed(user, ROUTE_ALIAS_TRANSCRIPT_DELETE);
	}

	public void assertUserTranscriptCreate(Map<String, Object> user) {
		assertRouteAllowed(user, ROUTE_ALIAS_USERTRANSCRIPT_CREATE);
	}

	public void assertUserTranscriptList(Map<String, Object> user) {
		assertRouteAllowed(user, ROUTE_ALIAS_USERTRANSCRIPT_LIST);
	}
