...
/**
 * Merges servlet parameters and JSON/form body the same way as the flexible body resolver for aliyunsms admin POSTs.
 */
public final class AliyunsmsAdminFlexibleInputMerge {

	private AliyunsmsAdminFlexibleInputMerge() {}
