...
@Component
public class AddSmsSignJobHandler implements DispatchHandler {

	private final AliyunsmsCreateSmsSignClient aliyunsmsCreateSmsSignClient;

	public AddSmsSignJobHandler(AliyunsmsCreateSmsSignClient aliyunsmsCreateSmsSignClient) {
		this.aliyunsmsCreateSmsSignClient = aliyunsmsCreateSmsSignClient;
	}
	...
	public void handle(Map<String, Object> payload) {
		...
		aliyunsmsCreateSmsSignClient.createSmsSign(companyId, signName, signSource, remark, thirdParty, qualificationId);
	}
