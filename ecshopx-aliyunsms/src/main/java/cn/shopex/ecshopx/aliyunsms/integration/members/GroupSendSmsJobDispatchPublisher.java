...
@Service
public class GroupSendSmsJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public GroupSendSmsJobDispatchPublisher(DispatchFacade dispatchFacade) {
		this.dispatchFacade = dispatchFacade;
	}

	public void enqueueGroupSendSms(Map<String, Object> payload) {
