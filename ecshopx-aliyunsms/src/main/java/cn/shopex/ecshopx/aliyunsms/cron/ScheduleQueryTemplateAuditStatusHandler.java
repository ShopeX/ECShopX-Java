...
public class ScheduleQueryTemplateAuditStatusHandler {

	private static final String HANDLER = "aliyunsms-query-template-audit-status";
	...
	public void execute() {
		...
		try {
			int jobsDispatched = templateService.scheduleQueryTemplateAuditStatus();
