...
public class ScheduleUpdateStatusHandler {

	private static final String HANDLER = "aliyunsms-update-task";
	...
	public void execute() {
		...
		try {
			int taskRowsUpdated = taskService.scheduleUpdateStatus();
			log.info("[cron][{}] done, cost={}ms, taskRowsUpdated={}", HANDLER, System.currentTimeMillis() - start, taskRowsUpdated);
		} catch (Exception e) {
