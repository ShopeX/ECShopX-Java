...
/** 笔记点赞 */
@Data
@MpTable(value = "wsugc_post_like", comment = "笔记点赞", indexes = {@MpIndex(name = "idx_post_id", columns = {"post_id"}), @MpIndex(name = "idx_disabled", columns = {"disabled"})})
public class PostLike {

    @MpId(value = "post_like_id", type = IdType.AUTO, columnType = "bigint")
