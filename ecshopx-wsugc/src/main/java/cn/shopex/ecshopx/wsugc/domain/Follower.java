...
/** 关注-用户/粉丝 */
@Data
@MpTable(value = "wsugc_follower")
public class Follower {

    /** id */
    @MpId(value = "follower_id", type = IdType.AUTO, columnType = "integer", comment = "id")
    ...
    /** 粉丝会员id */
    @MpField(value = "follower_user_id", columnType = "bigint", comment = "粉丝会员id")
