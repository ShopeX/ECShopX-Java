...
/** 话题 */
@Data
@MpTable(value = "wsugc_topic", comment = "话题", indexes = {@MpIndex(name = "idx_user_id", columns = {"user_id"}), @MpIndex(name = "idx_company_id", columns = {"company_id"}), @MpIndex(name = "idx_mobile", columns = {"mobile"})})
public class Topic {

    @MpId(value = "topic_id", type = IdType.AUTO, columnType = "bigint")
    private Long topicId;

    /** 话题名称 */
    @MpField(value = "topic_name", columnType = "string", length = 250, comment = "话题名称")
