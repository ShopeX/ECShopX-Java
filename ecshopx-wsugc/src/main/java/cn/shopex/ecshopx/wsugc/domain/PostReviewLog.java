...
/** 笔记审核日志 */
@Data
@MpTable(value = "wsugc_post_reviewlog", comment = "笔记审核日志", indexes = {@MpIndex(name = "idx_post_id", columns = {"post_id"}), @MpIndex(name = "idx_company_id", columns = {"company_id"})})
public class PostReviewLog {
    ...
    /** 笔记id */
    @MpField(value = "post_id", columnType = "bigint", nullable = true, comment = "笔记id")
    private Long postId;
