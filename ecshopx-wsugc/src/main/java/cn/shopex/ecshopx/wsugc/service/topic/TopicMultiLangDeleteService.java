...
@Service
public class TopicMultiLangDeleteService {
	...
	public TopicMultiLangDeleteService(NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
	...
	public void deleteMultiLangForTopics(List<Long> topicIds) {
