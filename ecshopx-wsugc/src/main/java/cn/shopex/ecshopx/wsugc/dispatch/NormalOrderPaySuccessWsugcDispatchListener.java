...
@Component
public class NormalOrderPaySuccessWsugcDispatchListener implements DispatchListener {

	private final WsugcNormalOrderPaySuccessApplyService wsugcNormalOrderPaySuccessApplyService;

	public NormalOrderPaySuccessWsugcDispatchListener(
			WsugcNormalOrderPaySuccessApplyService wsugcNormalOrderPaySuccessApplyService) {
		this.wsugcNormalOrderPaySuccessApplyService = wsugcNormalOrderPaySuccessApplyService;
	}
	...
	public void onEvent(Map<String, Object> payload) {
		...
		wsugcNormalOrderPaySuccessApplyService.applyAfterNormalOrderPaySuccess(companyId, rawOrder);
	}
