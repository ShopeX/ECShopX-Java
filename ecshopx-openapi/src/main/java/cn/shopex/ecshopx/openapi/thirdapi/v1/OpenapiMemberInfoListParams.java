...
public final class OpenapiMemberInfoListParams {

	private OpenapiMemberInfoListParams() {}

	public record AssociationsPagination(int page, Integer pageSize) {}

	public static AssociationsPagination resolveAssociationsPagination(
		...
		if (!OpenapiMemberQueryParams.isPhpTruthy(pageRaw)) {
			return new AssociationsPagination(1, 10);
		}
		...
		return new AssociationsPagination(page, pageSize);
	}
