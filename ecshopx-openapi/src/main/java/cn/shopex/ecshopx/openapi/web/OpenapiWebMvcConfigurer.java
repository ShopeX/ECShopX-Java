...
public class OpenapiWebMvcConfigurer implements WebMvcConfigurer {
	...
	public OpenapiWebMvcConfigurer(OpenapiAuthInterceptor openapiAuthInterceptor) {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(openapiAuthInterceptor)
				.addPathPatterns(OpenapiPathPatterns.PUBLIC_PATTERN, OpenapiPathPatterns.INTERNAL_PATTERN);
	}
}
