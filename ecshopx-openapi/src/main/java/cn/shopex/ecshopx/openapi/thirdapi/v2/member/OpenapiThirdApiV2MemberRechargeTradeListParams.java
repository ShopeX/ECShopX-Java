...
public final class OpenapiThirdApiV2MemberRechargeTradeListParams {

	private OpenapiThirdApiV2MemberRechargeTradeListParams() {}
	...
	public static PageSpec resolve(String pageParam, String pageSizeParam, Map<String, Object> body) {
		...
		if (rawPageSizeParsed >= 500) {
			throw new OpenapiMemberRechargeV2FailException(
		...
		if (page < 1) {
			throw new OpenapiMemberRechargeV2FailException(
					OpenapiErrorCode.SERVICE_MISSING_PARAMS, "当前页面最小值为1");
		}
		if (pageSize < 1 || pageSize > 500) {
			throw new OpenapiMemberRechargeV2FailException(
					OpenapiErrorCode.SERVICE_MISSING_PARAMS, "每页显示数量为1-500");
		}
