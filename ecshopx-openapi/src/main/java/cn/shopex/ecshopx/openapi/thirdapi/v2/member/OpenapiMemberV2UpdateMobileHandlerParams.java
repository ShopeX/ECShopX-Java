...
public final class OpenapiMemberV2UpdateMobileHandlerParams {

	private OpenapiMemberV2UpdateMobileHandlerParams() {}

	public static Map<String, Object> mergeAll(
			Map<String, Object> body,
			String userIdParam,
			String mobileParam,
			String newMobileParam) {
		LinkedHashMap<String, Object> out = new LinkedHashMap<>();
		putMerge(out, body, "user_id", userIdParam);
		putMerge(out, body, "mobile", mobileParam);
		putMerge(out, body, "new_mobile", newMobileParam);
		return out;
	}
