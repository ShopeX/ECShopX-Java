...
public final class OpenapiMemberV2UpdateGradeHandlerParams {

	private OpenapiMemberV2UpdateGradeHandlerParams() {}
	...
	public static Map<String, Object> mergeAll(
		...
		putMerge(out, body, "plat_account", platAccountParam);
		putMerge(out, body, "grade_id", gradeIdParam);
		putMerge(out, body, "grade_level", gradeLevelParam);
		return out;
	}
