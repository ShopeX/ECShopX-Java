...
public final class OpenapiThirdApiV2NormalItemsEntityListParams {

	private OpenapiThirdApiV2NormalItemsEntityListParams() {}
	...
	public static PageSpec resolve(String pageParam, String pageSizeParam, Map<String, Object> body) {
		...
		if (pageSize < 1 || pageSize > 500) {
			throw new OpenapiItemsV2FailException(
					OpenapiErrorCode.SERVICE_MISSING_PARAMS, "每页显示数量1-500");
		}
