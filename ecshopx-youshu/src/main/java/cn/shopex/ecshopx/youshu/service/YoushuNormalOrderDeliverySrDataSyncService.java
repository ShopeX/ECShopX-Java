...
@Service
public class YoushuNormalOrderDeliverySrDataSyncService {
	...
	public YoushuNormalOrderDeliverySrDataSyncService(
	...
	public void syncOrderAfterNormalDelivery(long companyId, Object orderIdRaw) {
		...
		youshuOrderPushPort.pushOrder(dataSourceId, buildOrderPayloadAfterDelivery(order), credentials);
	}

	private static Map<String, Object> buildOrderPayloadAfterDelivery(NormalOrders order) {
