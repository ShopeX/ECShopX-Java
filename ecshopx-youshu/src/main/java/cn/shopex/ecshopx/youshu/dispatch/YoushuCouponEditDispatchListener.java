...
@Component
public class YoushuCouponEditDispatchListener implements DispatchListener {

	private final YoushuCouponEditSrDataSyncService youshuCouponEditSrDataSyncService;

	public YoushuCouponEditDispatchListener(YoushuCouponEditSrDataSyncService youshuCouponEditSrDataSyncService) {
		this.youshuCouponEditSrDataSyncService = youshuCouponEditSrDataSyncService;
	}
	...
	public void onEvent(Map<String, Object> payload) {
		...
		youshuCouponEditSrDataSyncService.syncAfterCouponEdit(cardId, companyId);
	}
