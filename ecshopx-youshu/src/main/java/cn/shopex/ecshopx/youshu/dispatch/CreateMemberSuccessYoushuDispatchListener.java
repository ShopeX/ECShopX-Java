...
@Component
public class CreateMemberSuccessYoushuDispatchListener implements DispatchListener {

	private final YoushuMemberCreateSuccessSyncService syncService;

	public CreateMemberSuccessYoushuDispatchListener(YoushuMemberCreateSuccessSyncService syncService) {
	...
	public void onEvent(Map<String, Object> payload) {
		...
		syncService.syncMemberAfterCreate(companyId, userId);
	}
}
