...
@Service
public class YoushuSettingInfoPortImpl implements YoushuSettingInfoPort {

	private final YoushuSettingService youshuSettingService;

	public YoushuSettingInfoPortImpl(YoushuSettingService youshuSettingService) {
		this.youshuSettingService = youshuSettingService;
	}

	@Override
	public Map<String, Object> getInfo(long companyId) {
		return youshuSettingService.getInfo(companyId);
	}
}
