...
public class ScheduleAddWxappVisitPageHandler {
	...
	public void execute() {
		...
		try {
			youshuTaskService.scheduleAddWxappVisitPage();
			log.info(
					"[cron][youshu-add-wxapp-visit-page] done, cost={}ms",
					System.currentTimeMillis() - start);
		} catch (Exception e) {
			log.error("[cron][youshu-add-wxapp-visit-page] failed", e);
