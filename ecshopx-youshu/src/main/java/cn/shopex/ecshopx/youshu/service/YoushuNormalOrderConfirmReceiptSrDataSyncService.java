...
@Service
public class YoushuNormalOrderConfirmReceiptSrDataSyncService {
	...
	public YoushuNormalOrderConfirmReceiptSrDataSyncService(
	...
	public void syncOrderAfterNormalOrderConfirmReceipt(long companyId, Object orderIdRaw) {
		...
		youshuOrderPushPort.pushOrder(dataSourceId, buildOrderPayloadAfterConfirmReceipt(order), credentials);
	}

	private static Map<String, Object> buildOrderPayloadAfterConfirmReceipt(NormalOrders order) {
		...
		if (order.getOrderStatus() != null) {
			body.put("order_status", order.getOrderStatus());
		}
		if (order.getDeliveryStatus() != null) {
			body.put("delivery_status", order.getDeliveryStatus());
		}
		if (order.getDeliveryCorp() != null) {
			body.put("delivery_corp", order.getDeliveryCorp());
		}
		if (order.getDeliveryCode() != null) {
			body.put("delivery_code", order.getDeliveryCode());
		}
		if (order.getDeliveryTime() != null) {
			body.put("delivery_time", order.getDeliveryTime());
		}
		if (order.getEndTime() != null) {
			body.put("end_time", order.getEndTime());
		}
		return body;
	}
