...
@Component
public class YoushuCouponDeleteDispatchListener implements DispatchListener {

	private final YoushuCouponDeleteSrDataSyncService youshuCouponDeleteSrDataSyncService;

	public YoushuCouponDeleteDispatchListener(YoushuCouponDeleteSrDataSyncService youshuCouponDeleteSrDataSyncService) {
		this.youshuCouponDeleteSrDataSyncService = youshuCouponDeleteSrDataSyncService;
	}
	...
	public void onEvent(Map<String, Object> payload) {
		...
		youshuCouponDeleteSrDataSyncService.syncAfterCouponDelete(cardId, companyId);
	}
