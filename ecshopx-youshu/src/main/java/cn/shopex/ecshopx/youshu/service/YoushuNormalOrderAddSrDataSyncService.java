...
@Service
public class YoushuNormalOrderAddSrDataSyncService {

	/** Order-shaped data source type key (0) for data source resolution. */
	...
	public YoushuNormalOrderAddSrDataSyncService(
	...
	public void syncOrderAfterNormalAdd(long companyId, Object orderIdRaw) {
