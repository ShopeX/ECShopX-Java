...
@Component
public class NormalOrderAddYoushuDispatchListener implements DispatchListener {

	private final YoushuNormalOrderAddSrDataSyncService youshuNormalOrderAddSrDataSyncService;

	public NormalOrderAddYoushuDispatchListener(YoushuNormalOrderAddSrDataSyncService youshuNormalOrderAddSrDataSyncService) {
		this.youshuNormalOrderAddSrDataSyncService = youshuNormalOrderAddSrDataSyncService;
	}
	...
	public void onEvent(Map<String, Object> payload) {
		...
		youshuNormalOrderAddSrDataSyncService.syncOrderAfterNormalAdd(companyId, rawOrder);
	}
