...
@Component
public class NormalOrderDeliveryYoushuDispatchListener implements DispatchListener {

	private final YoushuNormalOrderDeliverySrDataSyncService youshuNormalOrderDeliverySrDataSyncService;

	public NormalOrderDeliveryYoushuDispatchListener(
			YoushuNormalOrderDeliverySrDataSyncService youshuNormalOrderDeliverySrDataSyncService) {
		this.youshuNormalOrderDeliverySrDataSyncService = youshuNormalOrderDeliverySrDataSyncService;
	}
	...
	public void onEvent(Map<String, Object> payload) {
		...
		youshuNormalOrderDeliverySrDataSyncService.syncOrderAfterNormalDelivery(companyId, rawOrder);
	}
