...
@Component
public class NormalOrderCancelYoushuDispatchListener implements DispatchListener {

	private final YoushuNormalOrderCancelSrDataSyncService youshuNormalOrderCancelSrDataSyncService;

	public NormalOrderCancelYoushuDispatchListener(
			YoushuNormalOrderCancelSrDataSyncService youshuNormalOrderCancelSrDataSyncService) {
		this.youshuNormalOrderCancelSrDataSyncService = youshuNormalOrderCancelSrDataSyncService;
	}
	...
	public void onEvent(Map<String, Object> payload) {
		...
		youshuNormalOrderCancelSrDataSyncService.syncOrderAfterNormalCancel(companyId, rawOrder);
	}
