...
@Component
public class NormalOrderConfirmReceiptYoushuDispatchListener implements DispatchListener {

	private final YoushuNormalOrderConfirmReceiptSrDataSyncService youshuNormalOrderConfirmReceiptSrDataSyncService;

	public NormalOrderConfirmReceiptYoushuDispatchListener(
			YoushuNormalOrderConfirmReceiptSrDataSyncService youshuNormalOrderConfirmReceiptSrDataSyncService) {
		this.youshuNormalOrderConfirmReceiptSrDataSyncService = youshuNormalOrderConfirmReceiptSrDataSyncService;
	}
	...
	public void onEvent(Map<String, Object> payload) {
		...
		youshuNormalOrderConfirmReceiptSrDataSyncService.syncOrderAfterNormalOrderConfirmReceipt(companyId, rawOrder);
	}
