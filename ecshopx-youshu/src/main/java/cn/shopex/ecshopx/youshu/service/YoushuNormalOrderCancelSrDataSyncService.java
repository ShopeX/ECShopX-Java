...
@Service
public class YoushuNormalOrderCancelSrDataSyncService {
	...
	public YoushuNormalOrderCancelSrDataSyncService(
	...
	public void syncOrderAfterNormalCancel(long companyId, Object orderIdRaw) {
		...
		youshuOrderPushPort.pushOrder(dataSourceId, buildOrderPayloadFromRow(order), credentials);
	}

	private static Map<String, Object> buildOrderPayloadFromRow(NormalOrders order) {
		...
		if (order.getCancelStatus() != null) {
			body.put("cancel_status", order.getCancelStatus());
		}
		return body;
	}
