...
public class ScheduleAddWxappVisitDistributionHandler {
	...
	public void execute() {
		...
		try {
			youshuTaskService.scheduleAddWxappVisitDistribution();
			log.info(
					"[cron][youshu-add-wxapp-visit-distr] done, cost={}ms",
					System.currentTimeMillis() - start);
		} catch (Exception e) {
			log.error("[cron][youshu-add-wxapp-visit-distr] failed", e);
