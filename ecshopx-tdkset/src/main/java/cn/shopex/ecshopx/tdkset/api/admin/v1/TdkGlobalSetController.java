...
@AdminAuth
@ShopLog
@RestController("tdkGlobalSetAdminV1")
@RequestMapping("/api/v1")
public class TdkGlobalSetController {
	...
	@Activated(routeAlias = "pcdecoration.tdkglobalset.info")
	@GetMapping(value = "/pcdecoration/tdkglobalset", name = "获取TDK全局配置信息")
	public ResponseEntity<?> getInfo(
		...
		tdkGivenSetMenuPermissionService.assertTdkGlobalInfo(user);

		Object payload = tdkGivenSaveService.getGlobalSetInfo(companyId, countryCode);
		return ResponseEntity.ok(ApiResult.ok(payload));
	}

	@Activated(routeAlias = "pcdecoration.tdkglobalset.save")
	@PostMapping(value = "/pcdecoration/tdkglobalset", name = "TDK全局信息添加&修改")
	public ResponseEntity<?> save(
		...
		tdkGivenSaveService.saveGlobalSet(companyId, reason, countryCodeRaw);
		...
		logCtx.put("request_uri", "/api/v1/pcdecoration/tdkglobalset");
		...
		logCtx.put("operator_name", "TDK全局信息添加&修改");
