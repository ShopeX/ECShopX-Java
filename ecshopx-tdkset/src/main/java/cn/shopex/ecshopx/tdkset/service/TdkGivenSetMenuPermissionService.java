...
@Service
public class TdkGivenSetMenuPermissionService {

	public static final String ROUTE_ALIAS_TDK_GIVEN_SAVE = "pcdecoration.tdkgivenset.save";

	public static final String ROUTE_ALIAS_TDK_GIVEN_INFO = "pcdecoration.tdkgivenset.info";

	public static final String ROUTE_ALIAS_TDK_GLOBAL_INFO = "pcdecoration.tdkglobalset.info";
	...
	public TdkGivenSetMenuPermissionService(
	...
	public void assertTdkGivenSave(Map<String, Object> user) {
		assertRouteAllowed(user, ROUTE_ALIAS_TDK_GIVEN_SAVE);
	}

	public void assertTdkGivenInfo(Map<String, Object> user) {
		assertRouteAllowed(user, ROUTE_ALIAS_TDK_GIVEN_INFO);
	}

	public void assertTdkGlobalInfo(Map<String, Object> user) {
		assertRouteAllowed(user, ROUTE_ALIAS_TDK_GLOBAL_INFO);
	}
