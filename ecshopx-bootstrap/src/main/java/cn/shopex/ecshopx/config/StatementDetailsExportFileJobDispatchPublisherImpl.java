...
@Component
@Profile("!test-cron")
public class StatementDetailsExportFileJobDispatchPublisherImpl
		implements StatementDetailsExportFileJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;
	private final Environment environment;

	public StatementDetailsExportFileJobDispatchPublisherImpl(
	...
	@Override
	public void enqueueDetailExport(long companyId, long operatorId, LinkedHashMap<String, Object> filter) {
		...
		dispatchFacade.dispatchJob(EspierDispatchJobNames.EXPORT_FILE_JOB_STATEMENTS_DETAIL, payload, options);
	}
}
