...
@Primary
@Component
public class TradeRefundDispatchPublisherImpl implements TradeRefundDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public TradeRefundDispatchPublisherImpl(DispatchFacade dispatchFacade) {
