...
@Component
public class UploadItemsToWdtErpJobDispatchPublisherImpl implements UploadItemsToWdtErpJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public UploadItemsToWdtErpJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
		this.dispatchFacade = dispatchFacade;
	}

	@Override
	public void enqueueUploadItemsToWdtErp(long companyId, List<Long> itemIds, long distributorId) {
