...
@Component
public class GoodsItemCategoryAddDispatchPublisherImpl implements GoodsItemCategoryAddDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public GoodsItemCategoryAddDispatchPublisherImpl(DispatchFacade dispatchFacade) {
