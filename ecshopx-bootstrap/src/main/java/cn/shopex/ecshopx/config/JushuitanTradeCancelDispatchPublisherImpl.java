...
@Component
public class JushuitanTradeCancelDispatchPublisherImpl implements JushuitanTradeCancelDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public JushuitanTradeCancelDispatchPublisherImpl(DispatchFacade dispatchFacade) {
		this.dispatchFacade = dispatchFacade;
	}

	@Override
	public void publish(Map<String, Object> cancelPayload) {
