...
@Component
public class DistributorCreateEventDispatchPublisherImpl implements DistributorCreateEventDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public DistributorCreateEventDispatchPublisherImpl(DispatchFacade dispatchFacade) {
