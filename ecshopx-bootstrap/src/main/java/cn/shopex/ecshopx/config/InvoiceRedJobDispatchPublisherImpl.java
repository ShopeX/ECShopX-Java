...
@Component
@Profile("!test-cron")
public class InvoiceRedJobDispatchPublisherImpl implements InvoiceRedJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public InvoiceRedJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
	...
	public void publish(Map<String, Object> aftersalesSnapshot) {
		Map<String, Object> payload =
				aftersalesSnapshot == null ? new LinkedHashMap<>() : new LinkedHashMap<>(aftersalesSnapshot);
