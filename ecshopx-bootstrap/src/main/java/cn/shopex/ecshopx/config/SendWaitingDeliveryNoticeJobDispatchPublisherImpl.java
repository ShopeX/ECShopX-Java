...
@Component
public class SendWaitingDeliveryNoticeJobDispatchPublisherImpl
		implements SendWaitingDeliveryNoticeJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public SendWaitingDeliveryNoticeJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
		this.dispatchFacade = dispatchFacade;
	}

	@Override
	public void publish(String companyId, String orderId, String distributorId) {
