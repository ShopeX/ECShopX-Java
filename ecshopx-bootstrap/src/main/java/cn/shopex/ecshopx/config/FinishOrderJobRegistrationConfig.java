...
public class FinishOrderJobRegistrationConfig {
	...
	private final FinishOrderJobHandler finishOrderJobHandler;

	public FinishOrderJobRegistrationConfig(
			DispatchRegistry dispatchRegistry, FinishOrderJobHandler finishOrderJobHandler) {
		this.dispatchRegistry = dispatchRegistry;
		this.finishOrderJobHandler = finishOrderJobHandler;
	}
