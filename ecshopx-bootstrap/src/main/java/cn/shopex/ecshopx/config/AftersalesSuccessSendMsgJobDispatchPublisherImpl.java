...
@Component
@Profile("!test-cron")
public class AftersalesSuccessSendMsgJobDispatchPublisherImpl implements AftersalesSuccessSendMsgJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public AftersalesSuccessSendMsgJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
