...
@Component
@Profile("!test-cron")
public class DeliveryStaffDataExportFileJobDispatchPublisherImpl implements DeliveryStaffDataExportFileJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public DeliveryStaffDataExportFileJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
