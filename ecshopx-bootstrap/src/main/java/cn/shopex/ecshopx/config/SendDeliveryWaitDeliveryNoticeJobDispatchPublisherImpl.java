...
@Component
public class SendDeliveryWaitDeliveryNoticeJobDispatchPublisherImpl
		implements SendDeliveryWaitDeliveryNoticeJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public SendDeliveryWaitDeliveryNoticeJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
