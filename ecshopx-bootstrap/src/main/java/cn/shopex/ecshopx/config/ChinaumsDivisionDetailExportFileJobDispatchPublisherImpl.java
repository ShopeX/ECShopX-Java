...
@Component
@Profile("!test-cron")
public class ChinaumsDivisionDetailExportFileJobDispatchPublisherImpl
		implements ChinaumsDivisionDetailExportFileJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public ChinaumsDivisionDetailExportFileJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
