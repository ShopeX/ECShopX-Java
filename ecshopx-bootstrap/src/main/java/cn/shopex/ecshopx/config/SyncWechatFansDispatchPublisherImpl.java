...
@Primary
@Component
public class SyncWechatFansDispatchPublisherImpl implements SyncWechatFansDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public SyncWechatFansDispatchPublisherImpl(DispatchFacade dispatchFacade) {
