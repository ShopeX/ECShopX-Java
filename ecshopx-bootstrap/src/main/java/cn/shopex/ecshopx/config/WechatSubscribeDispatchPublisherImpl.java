...
@Component
public class WechatSubscribeDispatchPublisherImpl implements WechatSubscribeDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public WechatSubscribeDispatchPublisherImpl(DispatchFacade dispatchFacade) {
