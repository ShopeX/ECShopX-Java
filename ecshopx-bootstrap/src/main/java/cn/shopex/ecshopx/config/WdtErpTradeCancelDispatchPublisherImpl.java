...
@Component
public class WdtErpTradeCancelDispatchPublisherImpl implements WdtErpTradeCancelDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public WdtErpTradeCancelDispatchPublisherImpl(DispatchFacade dispatchFacade) {
		this.dispatchFacade = dispatchFacade;
	}

	@Override
	public void publish(Map<String, Object> erpCancelPayload) {
