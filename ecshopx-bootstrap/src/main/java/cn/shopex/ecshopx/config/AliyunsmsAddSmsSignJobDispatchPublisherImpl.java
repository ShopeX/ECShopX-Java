...
@Component
@Profile("!test-cron")
public class AliyunsmsAddSmsSignJobDispatchPublisherImpl implements AliyunsmsAddSmsSignJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public AliyunsmsAddSmsSignJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
