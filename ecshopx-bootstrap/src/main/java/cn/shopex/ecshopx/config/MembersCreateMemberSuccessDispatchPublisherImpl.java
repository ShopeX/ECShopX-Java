...
@Component
public class MembersCreateMemberSuccessDispatchPublisherImpl implements MembersCreateMemberSuccessDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public MembersCreateMemberSuccessDispatchPublisherImpl(DispatchFacade dispatchFacade) {
