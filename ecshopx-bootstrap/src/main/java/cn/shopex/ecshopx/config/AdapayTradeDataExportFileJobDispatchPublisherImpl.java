...
@Component
public class AdapayTradeDataExportFileJobDispatchPublisherImpl implements AdapayTradeDataExportFileJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public AdapayTradeDataExportFileJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
		this.dispatchFacade = dispatchFacade;
	}

	@Override
	public void enqueueAdapayTradeDataExport(AdapayTradeDataExportContext ctx) {
