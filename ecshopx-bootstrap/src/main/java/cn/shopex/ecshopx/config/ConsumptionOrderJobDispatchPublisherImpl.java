...
@Component
@Profile("!test-cron")
public class ConsumptionOrderJobDispatchPublisherImpl implements ConsumptionOrderJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public ConsumptionOrderJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
