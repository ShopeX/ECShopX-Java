...
@Component
@Profile("!test-cron")
public class InvoiceRedQueryJobDispatchPublisherImpl implements InvoiceRedQueryJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public InvoiceRedQueryJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
