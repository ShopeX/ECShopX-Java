...
@Component
public class EmployeePurchaseActivityQrcodeExportDispatchPublisherImpl
		implements EmployeePurchaseActivityQrcodeExportDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public EmployeePurchaseActivityQrcodeExportDispatchPublisherImpl(DispatchFacade dispatchFacade) {
