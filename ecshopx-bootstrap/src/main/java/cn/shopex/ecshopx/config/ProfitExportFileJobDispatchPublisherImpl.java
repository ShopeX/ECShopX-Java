...
@Component
@Profile("!test-cron")
public class ProfitExportFileJobDispatchPublisherImpl implements ProfitExportFileJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;
	private final Environment environment;

	public ProfitExportFileJobDispatchPublisherImpl(DispatchFacade dispatchFacade, Environment environment) {
	...
	public void publish(
		...
		payload.put("type", exportTypeLowerCaseOrNull);
