...
@Component
public class MerchantAuditSuccessNoticeDispatchPublisherImpl implements MerchantAuditSuccessNoticeDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public MerchantAuditSuccessNoticeDispatchPublisherImpl(DispatchFacade dispatchFacade) {
