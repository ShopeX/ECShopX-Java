...
@Component
@Profile("!test-cron")
public class DistributorDataJobDispatchPublisherImpl implements DistributorDataJobEnqueuePort {

	private final DispatchFacade dispatchFacade;

	public DistributorDataJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
