...
@Component
public class MembersUpdateMemberSuccessDispatchPublisherImpl implements MembersUpdateMemberSuccessDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public MembersUpdateMemberSuccessDispatchPublisherImpl(DispatchFacade dispatchFacade) {
