...
@Component
@Profile("!test-cron")
public class SendAfterSaleWaitConfirmNoticeJobDispatchPublisherImpl
		implements SendAfterSaleWaitConfirmNoticeJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public SendAfterSaleWaitConfirmNoticeJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
