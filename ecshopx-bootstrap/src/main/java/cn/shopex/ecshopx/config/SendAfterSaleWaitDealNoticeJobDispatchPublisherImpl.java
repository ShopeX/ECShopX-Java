...
@Component
@Profile("!test-cron")
public class SendAfterSaleWaitDealNoticeJobDispatchPublisherImpl
		implements SendAfterSaleWaitDealNoticeJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public SendAfterSaleWaitDealNoticeJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
