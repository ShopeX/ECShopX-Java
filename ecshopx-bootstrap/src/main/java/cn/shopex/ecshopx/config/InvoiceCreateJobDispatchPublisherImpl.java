...
@Component
@Profile("!test-cron")
public class InvoiceCreateJobDispatchPublisherImpl implements InvoiceCreateJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public InvoiceCreateJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
