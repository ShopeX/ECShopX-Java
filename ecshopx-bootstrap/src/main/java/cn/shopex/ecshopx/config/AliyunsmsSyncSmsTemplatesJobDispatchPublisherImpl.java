...
@Component
@Profile("!test-cron")
public class AliyunsmsSyncSmsTemplatesJobDispatchPublisherImpl implements AliyunsmsSyncSmsTemplatesJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public AliyunsmsSyncSmsTemplatesJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
	...
	public void publish(long companyId) {
		dispatchFacade.dispatchJob(
				AliyunsmsDispatchJobNames.SYNC_SMS_TEMPLATES_JOB,
