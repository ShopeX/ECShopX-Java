...
@Component
@Profile("!test-cron")
public class AliyunsmsDeleteSmsTemplateJobDispatchPublisherImpl implements AliyunsmsDeleteSmsTemplateJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public AliyunsmsDeleteSmsTemplateJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
