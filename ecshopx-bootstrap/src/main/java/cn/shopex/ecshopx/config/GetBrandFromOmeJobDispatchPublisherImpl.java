...
@Component
public class GetBrandFromOmeJobDispatchPublisherImpl implements GetBrandFromOmeJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public GetBrandFromOmeJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
		this.dispatchFacade = dispatchFacade;
	}

	@Override
	public void enqueueGetBrandFromOme(long companyId, int page, long endLastmodifyUnixSeconds) {
