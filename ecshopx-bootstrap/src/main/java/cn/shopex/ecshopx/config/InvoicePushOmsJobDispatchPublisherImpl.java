...
@Component
@Profile("!test-cron")
public class InvoicePushOmsJobDispatchPublisherImpl implements InvoicePushOmsJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public InvoicePushOmsJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
