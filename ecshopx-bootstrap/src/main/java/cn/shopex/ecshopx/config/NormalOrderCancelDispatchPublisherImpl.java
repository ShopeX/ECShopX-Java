...
@Component
public class NormalOrderCancelDispatchPublisherImpl implements NormalOrderCancelDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public NormalOrderCancelDispatchPublisherImpl(DispatchFacade dispatchFacade) {
