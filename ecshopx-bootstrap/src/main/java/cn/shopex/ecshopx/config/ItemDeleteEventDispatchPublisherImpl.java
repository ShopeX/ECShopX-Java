...
@Component
public class ItemDeleteEventDispatchPublisherImpl implements ItemDeleteEventDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public ItemDeleteEventDispatchPublisherImpl(DispatchFacade dispatchFacade) {
