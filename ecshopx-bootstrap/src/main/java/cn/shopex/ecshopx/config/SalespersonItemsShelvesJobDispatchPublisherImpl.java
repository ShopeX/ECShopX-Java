...
@Component
@Profile("!test-cron")
public class SalespersonItemsShelvesJobDispatchPublisherImpl implements SalespersonItemsShelvesJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public SalespersonItemsShelvesJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
		this.dispatchFacade = dispatchFacade;
	}

	@Override
	public void publish(long companyId, long activityId, String activityType) {
