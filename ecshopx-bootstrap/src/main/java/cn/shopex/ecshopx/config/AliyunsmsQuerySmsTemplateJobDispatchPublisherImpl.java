...
@Component
@Profile("!test-cron")
public class AliyunsmsQuerySmsTemplateJobDispatchPublisherImpl implements AliyunsmsQuerySmsTemplateJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public AliyunsmsQuerySmsTemplateJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
