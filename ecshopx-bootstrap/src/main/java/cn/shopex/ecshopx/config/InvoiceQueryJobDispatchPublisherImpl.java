...
@Component
@Profile("!test-cron")
public class InvoiceQueryJobDispatchPublisherImpl implements InvoiceQueryJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public InvoiceQueryJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
