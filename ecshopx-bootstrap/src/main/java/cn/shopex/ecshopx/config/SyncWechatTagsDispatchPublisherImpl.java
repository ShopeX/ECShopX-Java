...
@Primary
@Component
public class SyncWechatTagsDispatchPublisherImpl implements SyncWechatTagsDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public SyncWechatTagsDispatchPublisherImpl(DispatchFacade dispatchFacade) {
