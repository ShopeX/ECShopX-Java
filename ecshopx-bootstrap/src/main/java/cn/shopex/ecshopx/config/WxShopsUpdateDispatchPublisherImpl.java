...
@Component
public class WxShopsUpdateDispatchPublisherImpl implements WxShopsUpdateDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public WxShopsUpdateDispatchPublisherImpl(DispatchFacade dispatchFacade) {
