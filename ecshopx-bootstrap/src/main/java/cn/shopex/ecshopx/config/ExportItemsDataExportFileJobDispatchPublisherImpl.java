...
@Component
@Profile("!test-cron")
public class ExportItemsDataExportFileJobDispatchPublisherImpl implements ExportItemsDataExportFileJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;
	private final Environment environment;

	public ExportItemsDataExportFileJobDispatchPublisherImpl(DispatchFacade dispatchFacade, Environment environment) {
	...
	public void publish(
		...
		dispatchFacade.dispatchJob(EspierDispatchJobNames.EXPORT_FILE_JOB_EXPORT_ITEMS_DATA, payload, options);
	}
}
