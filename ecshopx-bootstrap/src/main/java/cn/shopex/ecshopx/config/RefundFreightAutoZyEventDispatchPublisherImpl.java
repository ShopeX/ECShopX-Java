...
@Component
public class RefundFreightAutoZyEventDispatchPublisherImpl implements RefundFreightAutoZyEventDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public RefundFreightAutoZyEventDispatchPublisherImpl(DispatchFacade dispatchFacade) {
		this.dispatchFacade = dispatchFacade;
	}

	@Override
	public void publish(long companyId, int isRefundFreight) {
		Map<String, Object> entities = new LinkedHashMap<>();
		entities.put("is_refund_freight", isRefundFreight);
