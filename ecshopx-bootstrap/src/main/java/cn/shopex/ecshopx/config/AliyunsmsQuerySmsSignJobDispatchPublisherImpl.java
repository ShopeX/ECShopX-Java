...
@Component
@Profile("!test-cron")
public class AliyunsmsQuerySmsSignJobDispatchPublisherImpl implements AliyunsmsQuerySmsSignJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public AliyunsmsQuerySmsSignJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
