...
@Component
public class TradeRefundFinishEventDispatchPublisherImpl implements TradeRefundFinishEventDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public TradeRefundFinishEventDispatchPublisherImpl(DispatchFacade dispatchFacade) {
		this.dispatchFacade = dispatchFacade;
	}

	@Override
	public void publish(Map<String, Object> refundRowPayload) {
