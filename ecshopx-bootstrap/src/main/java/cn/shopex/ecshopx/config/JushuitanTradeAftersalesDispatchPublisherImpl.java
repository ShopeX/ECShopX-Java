...
@Component
public class JushuitanTradeAftersalesDispatchPublisherImpl implements JushuitanTradeAftersalesDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public JushuitanTradeAftersalesDispatchPublisherImpl(DispatchFacade dispatchFacade) {
