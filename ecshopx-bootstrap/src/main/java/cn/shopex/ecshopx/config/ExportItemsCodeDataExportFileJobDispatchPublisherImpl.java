...
@Component
@Profile("!test-cron")
public class ExportItemsCodeDataExportFileJobDispatchPublisherImpl
		implements ExportItemsCodeDataExportFileJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;
	private final Environment environment;

	public ExportItemsCodeDataExportFileJobDispatchPublisherImpl(DispatchFacade dispatchFacade, Environment environment) {
	...
	public void publish(long companyId, long operatorId, String operatorType, Long merchantId,
		...
		dispatchFacade.dispatchJob(EspierDispatchJobNames.EXPORT_FILE_JOB_EXPORT_ITEMS_CODE_DATA, payload, options);
	}
}
