...
@Component
@Profile("!test-cron")
public class DistributorItemsExportFileJobDispatchPublisherImpl implements DistributorItemsExportFileJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;
	private final Environment environment;

	public DistributorItemsExportFileJobDispatchPublisherImpl(DispatchFacade dispatchFacade, Environment environment) {
	...
	public void publish(
		...
		payload.put("accept_language", acceptLanguage == null ? "" : acceptLanguage);
