...
@Component
@Profile("!test-cron")
public class RefundByOrderUpdateOrderStatusJobDispatchPublisherImpl
		implements RefundByOrderUpdateOrderStatusJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public RefundByOrderUpdateOrderStatusJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
	...
	public void publish(long orderId, long companyId, String orderType) {
		...
		payload.put("order_type", orderType == null ? "" : orderType);
