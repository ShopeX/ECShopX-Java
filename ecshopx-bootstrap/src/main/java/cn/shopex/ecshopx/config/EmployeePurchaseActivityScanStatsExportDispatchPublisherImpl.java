...
@Component
public class EmployeePurchaseActivityScanStatsExportDispatchPublisherImpl
		implements EmployeePurchaseActivityScanStatsExportDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public EmployeePurchaseActivityScanStatsExportDispatchPublisherImpl(DispatchFacade dispatchFacade) {
		this.dispatchFacade = dispatchFacade;
	}

	@Override
	public void enqueue(ActivityAdminExportQuery query) {
