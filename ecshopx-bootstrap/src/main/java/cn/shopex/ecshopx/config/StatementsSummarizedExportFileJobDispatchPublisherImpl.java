...
@Component
@Profile("!test-cron")
public class StatementsSummarizedExportFileJobDispatchPublisherImpl
		implements StatementsSummarizedExportFileJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;
	private final Environment environment;

	public StatementsSummarizedExportFileJobDispatchPublisherImpl(
	...
	@Override
	public void enqueueSummarizedExport(long companyId, long operatorId, LinkedHashMap<String, Object> filter) {
		...
		dispatchFacade.dispatchJob(EspierDispatchJobNames.EXPORT_FILE_JOB_STATEMENTS_SUMMARIZED, payload, options);
	}
}
