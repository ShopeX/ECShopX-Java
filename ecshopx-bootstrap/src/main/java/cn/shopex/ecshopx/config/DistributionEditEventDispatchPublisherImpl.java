...
@Component
public class DistributionEditEventDispatchPublisherImpl implements DistributionEditEventDispatchPublisher {

	private static final DispatchOptions DISTRIBUTION_EDIT_FANOUT_PARENT_OPTIONS =
			new DispatchOptions(
					DispatchMode.ASYNC,
	...
	public DistributionEditEventDispatchPublisherImpl(DispatchFacade dispatchFacade) {
	...
	public void publish(Map<String, Object> row) {
		...
		dispatchFacade.publishEvent(
				...
				payload,
				DISTRIBUTION_EDIT_FANOUT_PARENT_OPTIONS);
		dispatchFacade.publishEvent(
