...
@Component
public class ReservationFinishDispatchPublisherImpl implements ReservationFinishDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public ReservationFinishDispatchPublisherImpl(DispatchFacade dispatchFacade) {
	...
	public void publish(Map<String, Object> entities) {
		...
		payload.put("entities", new LinkedHashMap<>(entities));
