...
@Component
public class OmeTradeUpdateDispatchPublisherImpl implements OmeTradeUpdateDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public OmeTradeUpdateDispatchPublisherImpl(DispatchFacade dispatchFacade) {
