...
@Component
public class JushuitanTradeFinishDispatchPublisherImpl implements JushuitanTradeFinishDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public JushuitanTradeFinishDispatchPublisherImpl(DispatchFacade dispatchFacade) {
