...
@Component
public class SendWxRemindJobDispatchPublisherImpl implements SendWxRemindJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public SendWxRemindJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
