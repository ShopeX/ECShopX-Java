...
@Component
public class WdtErpTradeFinishDispatchPublisherImpl implements WdtErpTradeFinishDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public WdtErpTradeFinishDispatchPublisherImpl(DispatchFacade dispatchFacade) {
