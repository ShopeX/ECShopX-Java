...
@Component
public class ItemBatchEditStatusEventJobDispatchPublisherImpl implements ItemBatchEditStatusEventJobEnqueuePort {

	private final DispatchFacade dispatchFacade;

	public ItemBatchEditStatusEventJobDispatchPublisherImpl(DispatchFacade dispatchFacade) {
		this.dispatchFacade = dispatchFacade;
	}

	@Override
	public void enqueueAfterApproveStatusUpdate(long companyId, long goodsId, String approveStatus) {
