...
@Component
public class ReservationFinishSuccWxaTemplatePortImpl implements ReservationFinishSuccWxaTemplatePort {

	private final WxaTemplateMsgActivityRemindSendService wxaTemplateMsgActivityRemindSendService;

	public ReservationFinishSuccWxaTemplatePortImpl(
	...
	@Override
	public void send(Map<String, Object> wxopenTemplatePayload) {
		wxaTemplateMsgActivityRemindSendService.send(wxopenTemplatePayload, false);
	}
}
