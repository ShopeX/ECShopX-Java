...
class InvoiceCreateJobDispatchPublisherImplTest {

	@Test
	void publish_delegatesToDispatchFacadeWithInvoiceCreateJobNameAndSlowQueue() {
		DispatchFacade facade = Mockito.mock(DispatchFacade.class);
		InvoiceCreateJobDispatchPublisherImpl impl = new InvoiceCreateJobDispatchPublisherImpl(facade);
		...
		assertEquals(OrdersDispatchJobNames.INVOICE_CREATE_JOB, nameCaptor.getValue());
