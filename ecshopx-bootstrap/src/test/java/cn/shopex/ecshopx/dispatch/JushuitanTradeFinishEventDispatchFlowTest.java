...
class JushuitanTradeFinishEventDispatchFlowTest {

	@Test
	void publishEvent_async_enqueuesSystemLinkJushuitanListener_andConsumerRunsListener() {
		...
		assertEquals(SystemLinkDispatchEventNames.EVENT_JUSHUITAN_TRADE_FINISH, msg.messageName());
		assertEquals("listener:systemlink.trade_finish_send_jushuitan", msg.listenerName());
