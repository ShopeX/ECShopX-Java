...
@Component
public class AftersalesCancelNoticeJobPortImpl implements AftersalesCancelNoticeJobPort {

	private final AftersalesRefundAsyncPort aftersalesRefundAsyncPort;

	public AftersalesCancelNoticeJobPortImpl(AftersalesRefundAsyncPort aftersalesRefundAsyncPort) {
	...
	public void scheduleSendAftersaleCancelNotice(long companyId, long aftersalesBn) {
		aftersalesRefundAsyncPort.scheduleSendAftersaleCancelNotice(companyId, aftersalesBn);
	}
}
