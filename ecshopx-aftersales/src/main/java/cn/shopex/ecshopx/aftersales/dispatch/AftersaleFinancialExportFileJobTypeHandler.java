...
@Component
public class AftersaleFinancialExportFileJobTypeHandler implements ExportFileJobTypeHandler {

	private final AftersalesFinancialExportFileJobHandler aftersalesFinancialExportFileJobHandler;

	public AftersaleFinancialExportFileJobTypeHandler(
			AftersalesFinancialExportFileJobHandler aftersalesFinancialExportFileJobHandler) {
		this.aftersalesFinancialExportFileJobHandler = aftersalesFinancialExportFileJobHandler;
	}

	@Override
	public String exportType() {
		return AftersalesFinancialExportFileJobHandler.EXPORT_FILE_JOB_TYPE_AFTERSALE_FINANCIAL;
	}
	...
	public void handle(Map<String, Object> payload) {
		...
		AftersalesFinancialExportJobContext ctx =
				new AftersalesFinancialExportJobContext(companyId, operatorId, filter);
		aftersalesFinancialExportFileJobHandler.run(ctx);
	}
