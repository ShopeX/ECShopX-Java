...
public class ScheduleRefundHandler {

	private static final String HANDLER_SHORT_NAME = "schedule-refund";
	...
	public void execute() {
		...
		try {
			int dispatched = aftersalesRefundService.scheduleRefund();
			long costMs = System.currentTimeMillis() - start;
			log.info(
					"[cron][{}] done, costMs={}, dispatched={}", HANDLER_SHORT_NAME, costMs, dispatched);
		} catch (Exception e) {
