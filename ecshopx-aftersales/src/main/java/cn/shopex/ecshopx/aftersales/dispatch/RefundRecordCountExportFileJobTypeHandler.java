...
@Component
public class RefundRecordCountExportFileJobTypeHandler implements ExportFileJobTypeHandler {

	private final AftersalesRefundRecordExportFileJobHandler aftersalesRefundRecordExportFileJobHandler;

	public RefundRecordCountExportFileJobTypeHandler(
			AftersalesRefundRecordExportFileJobHandler aftersalesRefundRecordExportFileJobHandler) {
		this.aftersalesRefundRecordExportFileJobHandler = aftersalesRefundRecordExportFileJobHandler;
	}

	@Override
	public String exportType() {
		return AftersalesRefundRecordExportFileJobHandler.EXPORT_FILE_JOB_TYPE_REFUND_RECORD_COUNT;
	}
	...
	public void handle(Map<String, Object> payload) {
		...
		AftersalesRefundRecordExportJobContext ctx =
				new AftersalesRefundRecordExportJobContext(companyId, operatorId, filter);
		aftersalesRefundRecordExportFileJobHandler.run(ctx);
	}
