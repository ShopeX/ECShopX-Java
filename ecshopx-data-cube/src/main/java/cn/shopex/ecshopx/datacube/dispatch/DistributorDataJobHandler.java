...
@Component
public class DistributorDataJobHandler implements DispatchHandler {

	private static final Logger log = LoggerFactory.getLogger(DistributorDataJobHandler.class);

	private final DistributorDataService distributorDataService;

	public DistributorDataJobHandler(DistributorDataService distributorDataService) {
	...
	public void handle(Map<String, Object> payload) {
		try {
			...
			long distributorId = longValue(payload.get("distributor_id"));
