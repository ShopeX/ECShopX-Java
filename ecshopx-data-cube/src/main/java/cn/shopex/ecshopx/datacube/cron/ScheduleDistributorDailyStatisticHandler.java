...
public class ScheduleDistributorDailyStatisticHandler {

	private static final String HANDLER_SHORT_NAME = "distributor-daily-statistic";
	...
	public void execute() {
		...
		try {
			var result = distributorDataService.scheduleInitStatistic();
			log.info(
