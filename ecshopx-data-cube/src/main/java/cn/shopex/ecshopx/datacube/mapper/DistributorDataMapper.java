...
@Mapper
public interface DistributorDataMapper extends BaseMapper<DistributorData> {

	List<Map<String, Object>> selectAggregatedByDistributorIds(
			@Param("companyId") long companyId,
			@Param("distributorIds") List<Long> distributorIds,
			@Param("start") LocalDate start,
			@Param("end") LocalDate end);

	List<Map<String, Object>> selectAggregatedByMerchantIds(
			@Param("companyId") long companyId,
