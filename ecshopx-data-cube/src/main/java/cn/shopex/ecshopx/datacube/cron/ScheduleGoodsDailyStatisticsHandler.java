...
public class ScheduleGoodsDailyStatisticsHandler {

	private static final String HANDLER_SHORT_NAME = "goods-daily-statistics";
	...
	public void execute() {
		...
		try {
			var result = goodsDataService.scheduleInitStatistic();
			log.info(
