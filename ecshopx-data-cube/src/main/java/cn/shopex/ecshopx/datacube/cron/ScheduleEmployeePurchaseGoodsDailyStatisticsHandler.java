...
public class ScheduleEmployeePurchaseGoodsDailyStatisticsHandler {

	private static final String HANDLER_SHORT_NAME = "employee-purchase-goods-daily-statistics";
	...
	public void execute() {
		...
		try {
			var result = goodsDataService.scheduleInitEmployeePurchaseStatistic();
			log.info(
					"[cron][{}] done, processed={}, costMs={}",
					HANDLER_SHORT_NAME,
					result.jobsEnqueued(),
