...
/**
 * 商户数据统计表。唯一约束：count_date、company_id、merchant_id（ix_date_company）。
 */
@Data
@MpTable(value = "datacube_merchant_data", comment = "商户数据统计表", uniqueIndexes = {@MpIndex(name = "ix_date_company", columns = {"count_date", "company_id", "merchant_id"})})
