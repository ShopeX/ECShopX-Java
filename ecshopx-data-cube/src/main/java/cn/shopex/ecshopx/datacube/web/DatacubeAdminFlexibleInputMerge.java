...
public final class DatacubeAdminFlexibleInputMerge {

	private DatacubeAdminFlexibleInputMerge() {}

	public static Map<String, Object> mergeQueryThenBody(HttpServletRequest request, Map<String, Object> body) {
		LinkedHashMap<String, Object> input = new LinkedHashMap<>();
		if (body != null) {
			input.putAll(body);
		}
		input.putAll(parameterMapToMap(request));
		return input;
	}
