 ...
 */
@Data
@MpTable(value = "bspay_regions_third", comment = "省市区编码(六位码或九位码)", indexes = {@MpIndex(name = "idx_area_name", columns = {"area_name"}), @MpIndex(name = "idx_area_code", columns = {"area_code"})})
public class RegionsThird {
