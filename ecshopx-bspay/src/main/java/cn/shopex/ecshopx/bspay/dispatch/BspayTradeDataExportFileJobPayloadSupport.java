...
public final class BspayTradeDataExportFileJobPayloadSupport {

	private BspayTradeDataExportFileJobPayloadSupport() {}

	public static BspayTradeDataExportContext contextFromPayload(Map<String, Object> payload) {
		...
		return new BspayTradeDataExportContext(companyId, jwtOperatorId, outputOperatorType, preparedFilter);
	}
