...
@Service
public class DefaultReplyRedisService {

	private static final String REDIS_KEY_PREFIX = "defaultReply:";
	private static final String SHA1_INPUT_SUFFIX = "message_default_autoreply_info";

	private final StringRedisTemplate sharedStringRedisTemplate;
	private final ObjectMapper objectMapper;

	public DefaultReplyRedisService(
	...
	public void setDefaultReply(String authorizerAppId, Object replyType, Object replyContent) {
		...
		try {
			...
			throw new IllegalStateException("default reply payload serialization failed", e);
		}
		sharedStringRedisTemplate.opsForValue().set(redisKey, json);
	}

	public Map<String, Object> getLastReplyContent(String authorizerAppId) {
		String saltInput = authorizerAppId == null ? "" : authorizerAppId;
		String digest = sha1HexUtf8(saltInput + SHA1_INPUT_SUFFIX);
		String redisKey = REDIS_KEY_PREFIX + digest;
