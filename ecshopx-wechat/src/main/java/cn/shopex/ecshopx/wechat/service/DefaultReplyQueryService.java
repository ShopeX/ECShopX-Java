...
@Service
public class DefaultReplyQueryService {
	...
	public DefaultReplyQueryService(
	...
	public Map<String, Object> getDefaultReply(String authorizerAppId) {
		Map<String, Object> data = defaultReplyRedisService.getLastReplyContent(authorizerAppId);
		if (data != null
				&& data.containsKey("reply_content")
				&& hasMeaningfulReplyContent(data.get("reply_content"))) {
			String replyTypeStr =
