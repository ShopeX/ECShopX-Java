...
@Component
public class WxaGenerateUrlLinkClient {
	...
	public WxaGenerateUrlLinkClient(WxJavaMaRuntime wxJavaMaRuntime, ObjectMapper objectMapper) {
		this.wxJavaMaRuntime = wxJavaMaRuntime;
		this.objectMapper = objectMapper;
	}

	public Map<String, Object> generate(String authorizerAppId, String path, String query, String envVersion) {
		GenerateUrlLinkRequest req =
				GenerateUrlLinkRequest.builder()
						.path(path)
		...
		try {
			responseBody =
					wxJavaMaRuntime.ma(authorizerAppId).getLinkService().generateUrlLink(req);
