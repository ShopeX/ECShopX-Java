...
import cn.shopex.ecshopx.wechat.wxa.WxaGenerateUrlSchemeClient;
...
@Service
public class WxappWxaUrlSchemeService {
	...
	private final WxaGenerateUrlSchemeClient wxaGenerateUrlSchemeClient;

	public WxappWxaUrlSchemeService(
			WeappMapper weappMapper,
			WechatAuthQueryService wechatAuthQueryService,
			WxaGenerateUrlSchemeClient wxaGenerateUrlSchemeClient) {
		this.weappMapper = weappMapper;
		this.wechatAuthQueryService = wechatAuthQueryService;
		this.wxaGenerateUrlSchemeClient = wxaGenerateUrlSchemeClient;
	}

	public Map<String, Object> wxaUrlSchema(long companyId, Map<String, Object> mergedParams) {
		...
		long expireTimeEpochSeconds = Instant.now().getEpochSecond() + 86400L;
		return wxaGenerateUrlSchemeClient.generate(
				wxaAppid, path, queryStringForWechat, envVersionForWechat, expireTimeEpochSeconds);
	}
