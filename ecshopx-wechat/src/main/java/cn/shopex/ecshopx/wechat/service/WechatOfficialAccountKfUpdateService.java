...
@Service
public class WechatOfficialAccountKfUpdateService {
	...
	public WechatOfficialAccountKfUpdateService(
	...
	public void updateWechatKf(
			String authorizerAppid,
			String account,
			String nickOrNull,
			Path avatarLocalPathOrNull) {
		...
		if (StringUtils.hasText(nickOrNull)) {
			wechatOfficialAccountKfAccountClient.updateKfNickname(accessToken, account, nickOrNull.trim());
		}
