...
public class DistributorIsValidSettingService {
	...
	public Map<String, Object> getOpenDividedSetting(long companyId) {
		return openDistributorDividedSettingRedisService.getOpenDistributorDivided(companyId);
	}
}
