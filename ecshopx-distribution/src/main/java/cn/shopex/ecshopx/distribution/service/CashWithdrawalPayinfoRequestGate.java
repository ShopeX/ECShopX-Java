...
@Service
public class CashWithdrawalPayinfoRequestGate {
	...
	public CashWithdrawalPayinfoRequestGate(
	...
	public Map<String, Object> validateBeforePayinfo(HttpServletRequest request, Map<String, Object> merged) {
		...
		if (!"salesperson_workwechat".equals(source)) {
			distributorMenuPermissionService.assertRouteAllowed(
					user, DistributorMenuPermissionService.ROUTE_ALIAS_FRONT_WXAPP_CASH_WITHDRAWAL_PAYINFO);
		}
