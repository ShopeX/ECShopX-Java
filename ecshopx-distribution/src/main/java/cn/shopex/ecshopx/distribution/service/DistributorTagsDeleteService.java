...
@Service
public class DistributorTagsDeleteService {

	private final DistributorTagsMapper distributorTagsMapper;

	public DistributorTagsDeleteService(DistributorTagsMapper distributorTagsMapper) {
		this.distributorTagsMapper = distributorTagsMapper;
	}

	@Transactional(rollbackFor = Exception.class)
	public void deleteByCompanyAndTagId(long companyId, long tagId) {
		try {
			...
			distributorTagsMapper.delete(wrapper);
