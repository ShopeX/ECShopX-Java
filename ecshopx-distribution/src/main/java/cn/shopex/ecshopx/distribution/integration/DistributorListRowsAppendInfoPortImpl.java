...
@Component
public class DistributorListRowsAppendInfoPortImpl implements DistributorListRowsAppendInfoPort {

	private final DistributorCouponListAppendService distributorCouponListAppendService;

	public DistributorListRowsAppendInfoPortImpl(DistributorCouponListAppendService distributorCouponListAppendService) {
