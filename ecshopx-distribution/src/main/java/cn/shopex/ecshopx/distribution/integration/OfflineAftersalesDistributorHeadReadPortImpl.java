...
@Component
public class OfflineAftersalesDistributorHeadReadPortImpl implements OfflineAftersalesDistributorHeadReadPort {

	private final DistributorRepositoryGetInfoSimpleService distributorRepositoryGetInfoSimpleService;

	public OfflineAftersalesDistributorHeadReadPortImpl(
	...
	public Optional<Map<String, Object>> findH5OfflineAftersalesHeadRow(
		...
		return distributorRepositoryGetInfoSimpleService.findH5OfflineAftersalesHeadRow(
				companyId, distributorIdFilterPositiveOrNull);
	}
}
