...
@Service
public class CashWithdrawalProcessRequestGate {
	...
	public CashWithdrawalProcessRequestGate(
	...
	public Map<String, Object> validateBeforeProcess(HttpServletRequest request) {
		...
		if (!"salesperson_workwechat".equals(source)) {
			distributorMenuPermissionService.assertRouteAllowed(
					user, DistributorMenuPermissionService.ROUTE_ALIAS_DISTRIBUTION_CASH_WITHDRAWAL_PROCESS);
		}
