...
@Component
public class UpdateAddressLatAndLngJobDispatchPublisher {

	private final DispatchFacade dispatchFacade;

	public UpdateAddressLatAndLngJobDispatchPublisher(DispatchFacade dispatchFacade) {
		this.dispatchFacade = dispatchFacade;
	}

	public void enqueueUpdateAddressLatAndLng(long companyId, long userId, long addressId) {
