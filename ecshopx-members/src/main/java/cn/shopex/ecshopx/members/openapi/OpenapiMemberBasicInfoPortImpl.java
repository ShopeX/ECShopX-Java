...
import cn.shopex.ecshopx.members.openapi.thirdapi.v1.OpenapiThirdApiV1MemberBasicInfoService;
import java.util.Map;
import org.springframework.stereotype.Component;

@Component
public class OpenapiMemberBasicInfoPortImpl implements OpenapiMemberBasicInfoPort {

	private final OpenapiThirdApiV1MemberBasicInfoService basicInfoService;

	public OpenapiMemberBasicInfoPortImpl(OpenapiThirdApiV1MemberBasicInfoService basicInfoService) {
	...
	public Object basicInfo(
			...
			String unionidRaw) {
		return basicInfoService.executeOpenapiBasicInfo(
				companyId,
				mobileQueryParam,
				unionidQueryParam,
