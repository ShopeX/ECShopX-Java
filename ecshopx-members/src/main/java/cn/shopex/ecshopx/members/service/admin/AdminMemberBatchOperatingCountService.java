...
@Service
public class AdminMemberBatchOperatingCountService {

	private final AdminMemberBatchOperatingMapper adminMemberBatchOperatingMapper;

	public AdminMemberBatchOperatingCountService(AdminMemberBatchOperatingMapper adminMemberBatchOperatingMapper) {
		this.adminMemberBatchOperatingMapper = adminMemberBatchOperatingMapper;
	}

	public long countMembersForBatchOperating(long companyId, Map<String, Object> filter) {
		...
		return adminMemberBatchOperatingMapper.countMembers(f);
	}
}
