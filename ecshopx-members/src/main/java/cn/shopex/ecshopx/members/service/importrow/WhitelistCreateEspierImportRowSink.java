...
@Component
public class WhitelistCreateEspierImportRowSink implements EspierImportRowSink {

	private final MembersWhitelistCreateDataService membersWhitelistCreateDataService;

	public WhitelistCreateEspierImportRowSink(MembersWhitelistCreateDataService membersWhitelistCreateDataService) {
		this.membersWhitelistCreateDataService = membersWhitelistCreateDataService;
	}

	@Override
	public String supportedFileType() {
		return "whitelist_create";
	}
	...
	public void acceptRow(
		...
		membersWhitelistCreateDataService.createData(
				companyId, m == null ? "" : String.valueOf(m), n == null ? "" : String.valueOf(n));
	}
}
