...
@Service
public class MedicationPersonnelDeleteService {

	private final MedicationPersonnelMapper medicationPersonnelMapper;

	public MedicationPersonnelDeleteService(MedicationPersonnelMapper medicationPersonnelMapper) {
		this.medicationPersonnelMapper = medicationPersonnelMapper;
	}

	@Transactional
	public void deleteMedicationPersonnel(long companyId, long userId, long id) {
		...
		medicationPersonnelMapper.delete(wrapper);
	}
}
