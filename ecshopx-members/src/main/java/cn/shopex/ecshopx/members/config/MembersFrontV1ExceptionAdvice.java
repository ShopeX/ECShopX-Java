...
/**
 * Front v1 members: Dingo {@link ResourceException} with {@link ResourceException#getFieldErrors()}
 * must include {@code data.errors} (global handler DINGO path does not expand that field).
 */
@RestControllerAdvice(basePackages = "cn.shopex.ecshopx.members.api.front.v1")
@Order(Ordered.HIGHEST_PRECEDENCE)
public class MembersFrontV1ExceptionAdvice {
