...
@Service
public class MemberAddressDeleteService {

	private final MembersAddressMapper membersAddressMapper;

	public MemberAddressDeleteService(MembersAddressMapper membersAddressMapper) {
		this.membersAddressMapper = membersAddressMapper;
	}

	public boolean deleteAddress(long companyId, long userId, long addressId) {
		int rows =
