...
@Service
public class OpenapiThirdApiV2MemberTagBatchUpdateService {
	...
	public OpenapiThirdApiV2MemberTagBatchUpdateService(
	...
	public Map<String, Object> executeOpenapiBatchUpdateMemberTags(
		...
		memberRelTagsBatchCreateService.createRelTags(userIds, resolvedTagIds, companyId);
