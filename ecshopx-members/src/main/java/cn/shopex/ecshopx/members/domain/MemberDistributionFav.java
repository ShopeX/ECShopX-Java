...
/** 会员店铺收藏 */
@Data
@MpTable(value = "members_distribution_fav", comment = "会员店铺收藏", indexes = {@MpIndex(name = "idx_company_id", columns = {"company_id"}), @MpIndex(name = "idx_user_id", columns = {"user_id"})})
public class MemberDistributionFav {
