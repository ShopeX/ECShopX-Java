...
@Service
public class MemberInvoiceGetService {

	private final MembersInvoicesMapper membersInvoicesMapper;

	public MemberInvoiceGetService(MembersInvoicesMapper membersInvoicesMapper) {
		this.membersInvoicesMapper = membersInvoicesMapper;
	}

	public Map<String, Object> getInvoice(long companyId, long userId, long invoicesId) {
		MembersInvoices row =
