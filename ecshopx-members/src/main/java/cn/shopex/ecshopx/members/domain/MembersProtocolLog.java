...
/** 会员隐私协议记录表 */
@Data
@MpTable(value = "members_protocol_log", comment = "会员隐私协议记录表", indexes = {@MpIndex(name = "idx_user_id", columns = {"user_id"}), @MpIndex(name = "idx_company_id", columns = {"company_id"})})
public class MembersProtocolLog {
