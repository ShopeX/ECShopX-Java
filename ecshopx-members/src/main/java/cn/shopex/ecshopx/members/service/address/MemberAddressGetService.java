...
@Service
public class MemberAddressGetService {

	private final MembersAddressMapper membersAddressMapper;

	public MemberAddressGetService(MembersAddressMapper membersAddressMapper) {
		this.membersAddressMapper = membersAddressMapper;
	}

	public Map<String, Object> getAddress(long companyId, long userId, long addressId) {
		MembersAddress row =
		...
		return MemberAddressResponseMaps.toRow(row);
	}
}
