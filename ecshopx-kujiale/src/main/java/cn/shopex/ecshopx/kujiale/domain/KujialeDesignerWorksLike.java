...
@Data
@MpTable(value = "kujiale_designer_works_like", indexes = {@MpIndex(name = "idx_design_id", columns = {"design_id"}), @MpIndex(name = "idx_user_id", columns = {"user_id"}), @MpIndex(name = "idx_plan_id", columns = {"plan_id"})})
public class KujialeDesignerWorksLike {
    ...
    /** 点赞用户id */
    @MpField(value = "user_id", columnType = "integer", nullable = true, comment = "点赞用户id")
