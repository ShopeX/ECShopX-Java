...
@Data
@MpTable(value = "kujiale_designer_works_rel_tags", indexes = {@MpIndex(name = "idx_design_id", columns = {"design_id"}), @MpIndex(name = "idx_category_id", columns = {"tag_category_id"}), @MpIndex(name = "idx_plan_id", columns = {"plan_id"}), @MpIndex(name = "idx_tag_id", columns = {"tag_id"})})
public class KujialeDesignerWorksRelTags {
