...
@Data
@MpTable(value = "kujiale_designer_works_rel_cities", indexes = {@MpIndex(name = "idx_design_id", columns = {"design_id"}), @MpIndex(name = "idx_plan_id", columns = {"plan_id"}), @MpIndex(name = "idx_city_id", columns = {"city_id"})})
public class KujialeDesignerWorksRelCities {
    ...
    /** 城市ID */
    @MpField(value = "city_id", columnType = "integer", comment = "城市ID")
