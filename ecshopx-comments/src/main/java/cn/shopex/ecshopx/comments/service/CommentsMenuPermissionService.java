...
@Service
public class CommentsMenuPermissionService {

	public static final String ROUTE_ALIAS_COMMENT_CREATE = "comment.create";
	public static final String ROUTE_ALIAS_COMMENT_UPDATE = "comment.update";
	public static final String ROUTE_ALIAS_COMMENTS_LIST = "comments.list";
	...
	public CommentsMenuPermissionService(
