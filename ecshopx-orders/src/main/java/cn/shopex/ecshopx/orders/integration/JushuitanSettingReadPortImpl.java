...
@Component
public class JushuitanSettingReadPortImpl implements JushuitanSettingReadPort {

	private final OrdersErpSettingRedisReadService deleg;

	public JushuitanSettingReadPortImpl(OrdersErpSettingRedisReadService deleg) {
		this.deleg = deleg;
	}

	@Override
	public Map<String, Object> readJushuitanSetting(long companyId) {
		return deleg.readJushuitanSetting(companyId);
	}
}
