...
@Service
public class UserInvoiceProtocolService {

	private final OrderInvoiceProtocolService orderInvoiceProtocolService;

	public UserInvoiceProtocolService(OrderInvoiceProtocolService orderInvoiceProtocolService) {
		this.orderInvoiceProtocolService = orderInvoiceProtocolService;
	}

	public Object getInvoiceProtocol(long companyId) {
		return orderInvoiceProtocolService.getInvoiceProtocolForH5(companyId);
	}
}
