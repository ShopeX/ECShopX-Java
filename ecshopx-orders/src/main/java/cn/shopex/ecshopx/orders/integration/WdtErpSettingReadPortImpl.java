...
@Component
public class WdtErpSettingReadPortImpl implements WdtErpSettingReadPort {

	private final OrdersErpSettingRedisReadService deleg;

	public WdtErpSettingReadPortImpl(OrdersErpSettingRedisReadService deleg) {
		this.deleg = deleg;
	}

	@Override
	public Map<String, Object> readWdtErpSetting(long companyId) {
		return deleg.readWdtErpSetting(companyId);
	}
}
