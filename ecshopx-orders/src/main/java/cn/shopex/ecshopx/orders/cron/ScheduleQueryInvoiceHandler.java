...
public class ScheduleQueryInvoiceHandler {

	private static final String HANDLER_SHORT = "query-invoice";
	...
	public void execute() {
		...
		try {
			int dispatched = orderInvoiceService.scheduleQueryInvoice();
			log.info(
