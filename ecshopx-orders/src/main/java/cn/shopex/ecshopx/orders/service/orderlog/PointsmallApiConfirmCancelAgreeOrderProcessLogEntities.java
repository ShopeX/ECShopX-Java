...
/**
 * Payload map for order process log when the merchant API agrees to cancel a pointsmall normal order refund.
 */
public final class PointsmallApiConfirmCancelAgreeOrderProcessLogEntities {

	private PointsmallApiConfirmCancelAgreeOrderProcessLogEntities() {}

	public static LinkedHashMap<String, Object> buildForAdminAgreeRefund(
			long orderId,
			long companyId,
			long operatorId,
			String operatorType,
		...
		entities.put("detail", "订单号：" + orderId + "，后台管理员同意退款");
