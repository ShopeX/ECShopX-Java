...
@Service
public class SupplierWxappOrderCreateFacade {

	private final WxappPhysicalNormalOrderCreateSupport wxappPhysicalNormalOrderCreateSupport;

	public SupplierWxappOrderCreateFacade(WxappPhysicalNormalOrderCreateSupport wxappPhysicalNormalOrderCreateSupport) {
		this.wxappPhysicalNormalOrderCreateSupport = wxappPhysicalNormalOrderCreateSupport;
	}

	public Map<String, Object> createOrder(WxappOrderCreateContext ctx) {
		return wxappPhysicalNormalOrderCreateSupport.create(ctx, "supplier_order");
	}

	public Map<String, Object> getOrderTempInfo(WxappOrderCreateContext ctx) {
		return wxappPhysicalNormalOrderCreateSupport.getOrderTempInfo(ctx, "supplier_order");
	}
}
