...
@Component
public class OpenapiOrderCancelReasonsPortImpl implements OpenapiOrderCancelReasonsPort {

	private final OrderCancelReasonConfig orderCancelReasonConfig;

	public OpenapiOrderCancelReasonsPortImpl(OrderCancelReasonConfig orderCancelReasonConfig) {
		this.orderCancelReasonConfig = orderCancelReasonConfig;
	}

	@Override
	public Map<String, String> listAllAsStringKeyMap() {
		return orderCancelReasonConfig.allReasonsAsStringKeyMap();
	}
}
