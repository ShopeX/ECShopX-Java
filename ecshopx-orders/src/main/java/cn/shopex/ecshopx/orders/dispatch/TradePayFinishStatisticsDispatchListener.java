...
@Component
public class TradePayFinishStatisticsDispatchListener implements DispatchListener {

	private final TradePayFinishStatisticsBusService tradePayFinishStatisticsBusService;

	public TradePayFinishStatisticsDispatchListener(TradePayFinishStatisticsBusService tradePayFinishStatisticsBusService) {
	...
	public void onEvent(Map<String, Object> payload) {
		...
		if (!tradePayFinishStatisticsBusService.isEligibleTradeSourceType(payload.get("trade_source_type"))) {
			return;
		}
		tradePayFinishStatisticsBusService.recordPayFinishStatistics(payload);
	}
