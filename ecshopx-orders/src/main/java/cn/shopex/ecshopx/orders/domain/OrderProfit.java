...
/** 订单利润分润 */
@Data
@MpTable(value = "orders_rel_profit", comment = "订单分润表")
public class OrderProfit {
    ...
    /** 分润完成之后金额，以分为单位 */
    @MpField(value = "total_fee", columnType = "bigint", nullable = true, comment = "分润完成之后金额，以分为单位")
    private Long totalFee;

    /** 支付订单金额，以分为单位 */
    @MpField(value = "pay_fee", columnType = "bigint", nullable = true, comment = "支付订单金额，以分为单位")
    private Long payFee;
    ...
    /** 计划结算时间 */
    @MpField(value = "plan_close_time", columnType = "bigint", nullable = true, comment = "计划结算时间", defaultValue = "0")
    private Long planCloseTime;
