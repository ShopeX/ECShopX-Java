...
public final class StatementDetailsExportFileJobPayloadSupport {

	private StatementDetailsExportFileJobPayloadSupport() {}

	public static StatementDetailsExportJobContext contextFromPayload(Map<String, Object> payload) {
		...
		return new StatementDetailsExportJobContext(companyId, operatorId, exportFilter);
	}
