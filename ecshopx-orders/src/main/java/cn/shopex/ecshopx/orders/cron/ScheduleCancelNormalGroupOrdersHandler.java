...
public class ScheduleCancelNormalGroupOrdersHandler {

	private static final String HANDLER_SHORT_NAME = "cancel-group-orders";

	private final GroupsOrderService groupsOrderService;
	...
	public void execute() {
		...
		try {
			int cancelled = groupsOrderService.scheduleCancelOrders();
