...
public class ScheduleCancelNormalSeckillOrdersHandler {

	private static final String HANDLER_SHORT_NAME = "cancel-seckill-orders";

	private final SeckillNormalOrderService seckillNormalOrderService;
	...
	public void execute() {
		...
		try {
			int cancelled = seckillNormalOrderService.scheduleCancelOrders();
