...
@Component
public class RefundFreightAutoZyDispatchListener implements DispatchListener {

	private final RefundFreightAutoZyDispatchExecutionService executionService;

	public RefundFreightAutoZyDispatchListener(RefundFreightAutoZyDispatchExecutionService executionService) {
