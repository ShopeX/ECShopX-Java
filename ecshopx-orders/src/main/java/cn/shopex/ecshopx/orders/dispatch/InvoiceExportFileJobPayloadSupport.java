...
public final class InvoiceExportFileJobPayloadSupport {

	private InvoiceExportFileJobPayloadSupport() {}

	public static InvoiceExportJobContext contextFromPayload(Map<String, Object> payload) {
		...
		String orderType =
				"normal".equals(String.valueOf(filter.get("order_type"))) ? "normal" : "supplier_order";
		return new InvoiceExportJobContext(companyId, operatorId, orderType, filter);
	}
