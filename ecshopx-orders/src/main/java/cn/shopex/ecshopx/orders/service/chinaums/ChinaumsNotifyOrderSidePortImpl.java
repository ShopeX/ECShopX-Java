...
package cn.shopex.ecshopx.orders.service.chinaums;
...
@Service
public class ChinaumsNotifyOrderSidePortImpl implements ChinaumsNotifyOrderSidePort {

	private final OrdersTradePaymentCallbackService ordersTradePaymentCallbackService;

	public ChinaumsNotifyOrderSidePortImpl(
	...
	@Override
	public void applyTradePaymentAfterChinaums(String outTradeNo, String status, Map<String, Object> options) {
