...
public class ScheduleCancelNormalOfflinePayOrdersHandler {

	private static final String HANDLER_SHORT_NAME = "cancel-offlinepay-orders";
	...
	public void execute() {
		...
		try {
			int cancelled = normalOrderCronService.scheduleOfflinePayCancelOrders();
