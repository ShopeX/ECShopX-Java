...
@Component
public class OrdersSupplierOrderSplitOnNormalOrderAddDispatchListener implements DispatchListener {

	private final SupplierOrderSplitOnNormalOrderAddService supplierOrderSplitOnNormalOrderAddService;

	public OrdersSupplierOrderSplitOnNormalOrderAddDispatchListener(
