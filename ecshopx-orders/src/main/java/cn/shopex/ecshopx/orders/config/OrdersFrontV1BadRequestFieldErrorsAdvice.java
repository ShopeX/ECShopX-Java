...
/**
 * Dingo-style {@link BadRequestException} for orders front v1: when the handler declares
 ...
 */
@RestControllerAdvice(basePackages = "cn.shopex.ecshopx.orders.api.front.v1")
@Order(Ordered.HIGHEST_PRECEDENCE)
public class OrdersFrontV1BadRequestFieldErrorsAdvice {
