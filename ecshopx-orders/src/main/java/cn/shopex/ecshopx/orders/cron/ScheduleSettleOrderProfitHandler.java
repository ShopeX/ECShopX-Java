...
public class ScheduleSettleOrderProfitHandler {

	private static final String HANDLER_SHORT_NAME = "settle-order-profit";
	...
	public void execute() {
		...
		try {
			int processed = orderProfitService.scheduleSettleProfit();
			log.info(
					"[cron][{}] done, cost={}ms, processed={}",
					HANDLER_SHORT_NAME,
