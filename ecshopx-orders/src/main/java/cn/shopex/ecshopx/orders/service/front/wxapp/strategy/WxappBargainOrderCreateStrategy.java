...
@Component("wxappOrderTypeCreateBargain")
public class WxappBargainOrderCreateStrategy implements WxappOrderTypeCreateStrategy {

	private final WxappPhysicalNormalOrderCreateSupport wxappPhysicalNormalOrderCreateSupport;

	public WxappBargainOrderCreateStrategy(WxappPhysicalNormalOrderCreateSupport wxappPhysicalNormalOrderCreateSupport) {
	...
	public Map<String, Object> create(WxappOrderCreateContext ctx) {
		return wxappPhysicalNormalOrderCreateSupport.create(ctx, "bargain");
	}

	@Override
	public Map<String, Object> getOrderTempInfo(WxappOrderCreateContext ctx) {
		return wxappPhysicalNormalOrderCreateSupport.getOrderTempInfo(ctx, "bargain");
	}
}
