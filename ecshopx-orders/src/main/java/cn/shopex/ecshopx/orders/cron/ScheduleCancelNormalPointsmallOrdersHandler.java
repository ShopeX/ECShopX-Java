...
public class ScheduleCancelNormalPointsmallOrdersHandler {

	private static final String HANDLER_SHORT_NAME = "cancel-pointsmall-orders";

	private final PointsmallNormalOrderService pointsmallNormalOrderService;
