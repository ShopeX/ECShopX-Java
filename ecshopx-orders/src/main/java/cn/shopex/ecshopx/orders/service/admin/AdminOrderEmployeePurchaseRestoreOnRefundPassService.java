...
@Service
public class AdminOrderEmployeePurchaseRestoreOnRefundPassService {

	private final EmployeePurchaseOrderCancelRestorePort employeePurchaseOrderCancelRestorePort;

	public AdminOrderEmployeePurchaseRestoreOnRefundPassService(
	...
	public void restoreIfEmployeePurchaseOrder(long companyId, long orderId) {
		employeePurchaseOrderCancelRestorePort.restoreAfterRefundPassApproved(companyId, orderId);
	}
}
