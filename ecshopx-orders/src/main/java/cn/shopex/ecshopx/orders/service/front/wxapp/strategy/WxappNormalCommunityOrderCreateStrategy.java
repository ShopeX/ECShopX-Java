...
@Component("wxappOrderTypeCreateNormalCommunity")
public class WxappNormalCommunityOrderCreateStrategy implements WxappOrderTypeCreateStrategy {

	private final WxappPhysicalNormalOrderCreateSupport wxappPhysicalNormalOrderCreateSupport;

	public WxappNormalCommunityOrderCreateStrategy(WxappPhysicalNormalOrderCreateSupport wxappPhysicalNormalOrderCreateSupport) {
	...
	public Map<String, Object> create(WxappOrderCreateContext ctx) {
		return wxappPhysicalNormalOrderCreateSupport.create(ctx, "normal_community");
	}

	@Override
	public Map<String, Object> getOrderTempInfo(WxappOrderCreateContext ctx) {
		return wxappPhysicalNormalOrderCreateSupport.getOrderTempInfo(ctx, "normal_community");
	}
}
