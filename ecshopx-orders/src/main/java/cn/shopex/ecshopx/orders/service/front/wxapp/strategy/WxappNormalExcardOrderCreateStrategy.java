...
@Component("wxappOrderTypeCreateNormalExcard")
public class WxappNormalExcardOrderCreateStrategy implements WxappOrderTypeCreateStrategy {

	private final WxappPhysicalNormalOrderCreateSupport wxappPhysicalNormalOrderCreateSupport;

	public WxappNormalExcardOrderCreateStrategy(WxappPhysicalNormalOrderCreateSupport wxappPhysicalNormalOrderCreateSupport) {
	...
	public Map<String, Object> create(WxappOrderCreateContext ctx) {
		return wxappPhysicalNormalOrderCreateSupport.create(ctx, "normal_excard");
	}

	@Override
	public Map<String, Object> getOrderTempInfo(WxappOrderCreateContext ctx) {
		return wxappPhysicalNormalOrderCreateSupport.getOrderTempInfo(ctx, "normal_excard");
	}
}
