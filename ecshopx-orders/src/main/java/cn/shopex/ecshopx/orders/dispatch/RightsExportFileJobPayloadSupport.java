...
public final class RightsExportFileJobPayloadSupport {

	private RightsExportFileJobPayloadSupport() {}

	public static RightsExportJobContext contextFromPayload(Map<String, Object> payload) {
		...
		return new RightsExportJobContext(companyId, operatorId, filter);
	}
