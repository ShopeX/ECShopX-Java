...
@Component
public class ProfitSharingDispatchListener implements DispatchListener {

	private final HfpayProfitSharingDispatchExecutionService executionService;

	public ProfitSharingDispatchListener(HfpayProfitSharingDispatchExecutionService executionService) {
