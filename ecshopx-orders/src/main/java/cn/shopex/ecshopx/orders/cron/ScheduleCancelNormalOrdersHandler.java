...
public class ScheduleCancelNormalOrdersHandler {

	private static final String HANDLER_SHORT_NAME = "cancel-orders";
	...
	public void execute() {
		...
		try {
			int cancelled = normalOrderCronService.scheduleCancelOrders();
