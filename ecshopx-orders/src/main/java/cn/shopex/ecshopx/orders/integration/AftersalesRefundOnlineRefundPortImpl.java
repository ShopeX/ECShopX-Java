...
@Component
public class AftersalesRefundOnlineRefundPortImpl implements AftersalesRefundOnlineRefundPort {

	private final AftersalesRefundDoRefundService aftersalesRefundDoRefundService;

	public AftersalesRefundOnlineRefundPortImpl(AftersalesRefundDoRefundService aftersalesRefundDoRefundService) {
		this.aftersalesRefundDoRefundService = aftersalesRefundDoRefundService;
	}

	@Override
	public void executeRefund(long companyId, long refundBn) {
		aftersalesRefundDoRefundService.doRefund(companyId, refundBn, false);
	}
}
