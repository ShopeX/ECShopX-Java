...
public class ScheduleCreateInvoiceHandler {

	private static final String HANDLER_SHORT = "create-invoice";
	...
	public void execute() {
		...
		try {
			int dispatched = orderInvoiceService.scheduleCreateInvoice();
			log.info(
