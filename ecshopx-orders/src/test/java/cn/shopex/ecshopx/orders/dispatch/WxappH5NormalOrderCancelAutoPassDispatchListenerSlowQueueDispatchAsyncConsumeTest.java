...
@DisplayName("EVENT_NORMAL_ORDER_CANCEL: wxapp h5 cancel — auto pass listener DispatchConsumerRuntime consume (slow queue)")
class WxappH5NormalOrderCancelAutoPassDispatchListenerSlowQueueDispatchAsyncConsumeTest {
	...
	void consume_async_shaped_message_invokes_pass_refund_when_gates_open() {
		...
		DispatchMessage msg =
				new DispatchMessage(
						...
						occurredAt,
						"trace-wxapp-h5-normal-order-cancel-auto-pass-async-consume",
						LISTENER_NAME);
