...
@DisplayName("EVENT_ORDER_PROCESS_LOG: groups normal schedule cancel shaped async consume (slow)")
class GroupsNormalOrderScheduleCancelOrderProcessLogEventAsyncConsumeTest {

	private static final String LISTENER_NAME = "listener:orders.listeners.OrderProcess.OrderProcessLog";

	@Test
	void consume_asyncSlowGroupsNormalScheduleCancelShapedMessage_invokesOrderProcessLogBusServicePersistEntitiesMapOnce() {
		...
		DispatchMessage msg =
				new DispatchMessage(
						...
						occurredAt,
						"trace-groups-normal-schedule-cancel-opl-async-consume",
						LISTENER_NAME);
