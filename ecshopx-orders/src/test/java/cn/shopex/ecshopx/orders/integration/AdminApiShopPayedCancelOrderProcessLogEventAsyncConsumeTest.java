...
@DisplayName(
		"EVENT_ORDER_PROCESS_LOG: admin shop PAYED cancel — DispatchConsumerRuntime consume (slow, payed-cancel payload)")
class AdminApiShopPayedCancelOrderProcessLogEventAsyncConsumeTest {
	...
	@Test
	void consume_adminShopPayedCancelShapedAsyncMessage_invokesOrderProcessLogBusServicePersistEntitiesMapOnce() {
		...
		DispatchMessage msg =
				new DispatchMessage(
						...
						occurredAt,
						"trace-admin-api-shop-payed-cancel-opl-async-consume",
						LISTENER_NAME);
