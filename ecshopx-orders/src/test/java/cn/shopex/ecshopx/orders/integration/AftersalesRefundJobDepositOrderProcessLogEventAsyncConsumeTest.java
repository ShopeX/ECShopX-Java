...
@DisplayName("EVENT_ORDER_PROCESS_LOG: RefundJob/deposit async consume (slow)")
class AftersalesRefundJobDepositOrderProcessLogEventAsyncConsumeTest {

	private static final String LISTENER_NAME = "listener:orders.listeners.OrderProcess.OrderProcessLog";

	@Test
	void consume_asyncSlowDepositRefundSuccessShapedMessage_invokesOrderProcessLogBusServicePersistEntitiesMapOnce() {
