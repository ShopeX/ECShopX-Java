...
class NormalOrderZitiWriteoffServiceThirdPartyTradeUpdatePublishProbeTest {
	...
	@Test
	void applyZitiWriteoff_whenTradeIdPresent_publishesThirdPartyTradeUpdateWithOrderInfoPayload() {
		long companyId = 12L;
		long orderId = 70001L;
		long operatorId = 88L;

		NormalOrders order = eligibleOrder(companyId, orderId);
	...
	@Test
	void applyZitiWriteoff_whenTradeIdBlank_neverPublishesThirdPartyTradeUpdate() {
		long companyId = 12L;
		long orderId = 70001L;
		...
		service.orderZitiWriteoffForAdmin(companyId, orderId, 1L, false, "");
	...
	@Test
	void applyZitiWriteoff_whenOrderInfoMissing_skipsPublish() {
		long companyId = 12L;
		long orderId = 70002L;
	...
	private static NormalOrders eligibleOrder(long companyId, long orderId) {
