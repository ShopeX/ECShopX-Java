...
/**
 * Publish-side probe for {@link PointsmallNormalOrderService#scheduleCancelOrders()} order-process-log path
 * (pointsmall schedule cancel), aligned with async listener payload expectations.
 */
@ExtendWith(MockitoExtension.class)
class PointsmallNormalOrderServiceScheduleCancelOplDispatchPublishProbeTest {
	...
	@Test
	void scheduleCancelOrders_invokesOrderProcessLogPublishPortOnce_withPointsmallScheduleCancelOplPayload() {
		long orderId = 100L;
		long companyId = 1L;
		...
		order.setUserId(10L);
		order.setOrderClass("pointsmall");
