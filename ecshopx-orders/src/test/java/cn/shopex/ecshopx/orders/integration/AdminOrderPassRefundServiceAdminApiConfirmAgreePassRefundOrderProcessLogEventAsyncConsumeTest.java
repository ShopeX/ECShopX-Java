...
@DisplayName(
		"Admin confirm-cancel agree path dispatches order process log; async consume matches expected payload")
class AdminOrderPassRefundServiceAdminApiConfirmAgreePassRefundOrderProcessLogEventAsyncConsumeTest {
	...
	void consume_adminApiConfirmAgreePassRefundAsyncMessage_invokesOrderProcessLogBusServicePersistEntitiesMapOnce() {
		...
		expectedPayload.put("detail", "订单号：200，后台管理员同意退款");
		...
		DispatchMessage msg =
				new DispatchMessage(
						...
						occurredAt,
						"trace-admin-api-confirm-agree-pass-refund-opl-async-consume",
						LISTENER_NAME);
