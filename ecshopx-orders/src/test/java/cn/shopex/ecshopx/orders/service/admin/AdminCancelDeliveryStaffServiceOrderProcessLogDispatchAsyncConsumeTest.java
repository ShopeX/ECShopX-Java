...
@DisplayName("EVENT_ORDER_PROCESS_LOG: admin cancel delivery staff — DispatchConsumerRuntime consume (slow)")
class AdminCancelDeliveryStaffServiceOrderProcessLogDispatchAsyncConsumeTest {
	...
	@Test
	void consume_cancelDeliveryStaffShapedAsyncMessage_invokesPersistEntitiesMapOnce() {
		long companyId = 100L;
		long orderId = 200L;
		long operatorId = 42L;
		...
		DispatchMessage msg =
				new DispatchMessage(
						...
						occurredAt,
						"trace-admin-cancel-delivery-staff-opl-async-consume",
						LISTENER_NAME);
