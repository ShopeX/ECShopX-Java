...
@DisplayName("EVENT_ORDER_PROCESS_LOG: admin API cancel NOTPAY+PENDING — publishEvent probe (shop)")
class AdminNormalOrderFullCancelServiceAdminApiShopNotpayCancelOrderProcessLogDispatchPublishProbeTest {
	...
	void notPay_shopCancel_afterCommit_invokesPublishEventWithAdminShopShapedOplPayload() {
		...
		runNotPayCancelInTx(svc, merged, "shop");
		...
		assertThat(payload.get("detail")).isEqualTo("订单号：200，来源：shop");
