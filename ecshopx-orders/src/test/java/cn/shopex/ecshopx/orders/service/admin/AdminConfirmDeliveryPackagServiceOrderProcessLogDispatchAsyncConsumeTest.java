...
@DisplayName("EVENT_ORDER_PROCESS_LOG: admin confirm delivery packaged — DispatchConsumerRuntime consume (slow)")
class AdminConfirmDeliveryPackagServiceOrderProcessLogDispatchAsyncConsumeTest {
	...
	@Test
	void consume_packagedConfirmShapedAsyncMessage_invokesPersistEntitiesMapOnce() {
		long companyId = 100L;
		long orderId = 200L;
		long operatorId = 42L;
		...
		DispatchMessage msg =
				new DispatchMessage(
						...
						occurredAt,
						"trace-admin-confirm-delivery-packaged-opl-async-consume",
						LISTENER_NAME);
