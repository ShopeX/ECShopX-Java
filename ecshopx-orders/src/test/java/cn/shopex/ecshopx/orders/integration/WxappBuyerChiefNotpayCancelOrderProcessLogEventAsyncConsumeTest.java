...
@DisplayName("EVENT_ORDER_PROCESS_LOG: wxapp buyer|chief NOTPAY cancel — DispatchConsumerRuntime consume (slow)")
class WxappBuyerChiefNotpayCancelOrderProcessLogEventAsyncConsumeTest {
	...
	@Test
	void consume_wxappBuyerNotpayCancelShapedAsyncMessage_invokesOrderProcessLogBusServicePersistEntitiesMapOnce() {
		...
		expectedPayload.put("detail", "订单号：200，来源：buyer");
		...
		DispatchMessage msg =
				new DispatchMessage(
						...
						occurredAt,
						"trace-wxapp-buyer-notpay-cancel-opl-async-consume",
						LISTENER_NAME);
	...
	@Test
	void consume_wxappChiefNotpayCancelShapedAsyncMessage_invokesOrderProcessLogBusServicePersistEntitiesMapOnce() {
		LinkedHashMap<String, Object> innerParams = new LinkedHashMap<>();
		innerParams.put("order_id", "200");
		innerParams.put("company_id", 1L);
		...
		DispatchMessage msg =
				new DispatchMessage(
						...
						RetryPolicy.platformDefault(),
						occurredAt,
						"trace-wxapp-chief-notpay-cancel-opl-async-consume",
						LISTENER_NAME);
