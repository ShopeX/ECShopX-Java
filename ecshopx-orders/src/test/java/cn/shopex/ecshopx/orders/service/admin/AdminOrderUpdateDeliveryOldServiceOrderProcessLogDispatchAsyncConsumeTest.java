...
@DisplayName("EVENT_ORDER_PROCESS_LOG: admin updateDeliveryOld — DispatchConsumerRuntime consume (slow)")
class AdminOrderUpdateDeliveryOldServiceOrderProcessLogDispatchAsyncConsumeTest {
	...
	@Test
	void consume_updateDeliveryOldShapedAsyncMessage_invokesPersistEntitiesMapOnce() {
		long companyId = 100L;
		long orderId = 200L;
		long operatorId = 42L;
		String pathRaw = "200";
		...
		innerParams.put("delivery_code", "SF123");
		...
		expectedPayload.put("detail", "订单号：" + pathRaw + "，订单发货信息修改");
		...
		DispatchMessage msg =
				new DispatchMessage(
						...
						occurredAt,
						"trace-admin-update-delivery-old-opl-async-consume",
						LISTENER_NAME);
