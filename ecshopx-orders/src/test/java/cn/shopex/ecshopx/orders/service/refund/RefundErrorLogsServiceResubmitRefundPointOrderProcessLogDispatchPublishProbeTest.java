...
@DisplayName("EVENT_ORDER_PROCESS_LOG: resubmitRefund/point publishEvent probe")
class RefundErrorLogsServiceResubmitRefundPointOrderProcessLogDispatchPublishProbeTest {

	private static final String LOG_ID_SUCCESS = "9011";
	...
	@Test
	void resubmitRefund_point_success_invokesPublishEventOnce_withDispatchServiceAlignedDetail() {
		...
		OrderProcessLogPublishPort adapaySideOrderProcessLogPublishPort = mock(OrderProcessLogPublishPort.class);
		...
		long companyId = 91511L;
		long refundBn = 51511L;
		long orderId = 61511L;
		...
		refundBefore.setTradeId("tr-point-resubmit-1");
		refundBefore.setPayType("point");
		refundBefore.setRefundFee(0);
		refundBefore.setFreightType("cash");
		refundBefore.setFreight(0);
		refundBefore.setRefundPoint(18);
		...
		refundAfter.setTradeId("tr-point-resubmit-1");
		refundAfter.setPayType("point");
		...
		refundAfter.setRefundedPoint(18);
		...
		trade.setTradeId("tr-point-resubmit-1");
		...
		AftersalesRefundDoRefundService aftersalesRefundDoRefundService =
				new AftersalesRefundDoRefundService(ordersRefundPaymentDispatchService,
						...
						adapaySideOrderProcessLogPublishPort,
		...
		verify(adapaySideOrderProcessLogPublishPort, never()).publish(any());
	}
}
