...
/**
 * Probes {@link AdminOrderPassRefundService#transactionalPointsmallOne} agree branch: single OPL publish via port
 * implementation wired to {@link DispatchFacade}.
 */
@ExtendWith(MockitoExtension.class)
class AdminOrderPassRefundServicePointsmallConfirmCancelOrderProcessLogDispatchPublishProbeTest {
	...
	@Test
	void confirmAgreePointsmallRefund_invokesPublishEventOnce_withApiAgreeRefundOplPayload() {
		...
		svc.transactionalPointsmallOne(refund, "1", "", params);
