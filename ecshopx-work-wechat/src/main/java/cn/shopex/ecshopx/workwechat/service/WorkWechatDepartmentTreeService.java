...
import cn.shopex.ecshopx.workwechat.util.WorkWechatMakeTree;
import java.util.List;
import java.util.Map;
import org.springframework.stereotype.Service;

@Service
public class WorkWechatDepartmentTreeService {
	...
	public WorkWechatDepartmentTreeService(
	...
	public List<Map<String, Object>> getDepartmentTree(long companyId) {
		...
		List<Map<String, Object>> flat = workWechatCorpUserApiService.listDepartments(companyId);
		return WorkWechatMakeTree.makeTree(flat);
	}
}
