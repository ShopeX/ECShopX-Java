...
/** 积分商品关联属性表 */
@Data
@MpTable(value = "pointsmall_items_rel_attributes", comment = "积分商品关联属性表", indexes = {@MpIndex(name = "ix_company_id", columns = {"company_id"}), @MpIndex(name = "ix_item_id", columns = {"item_id"}), @MpIndex(name = "ix_attribute_type", columns = {"attribute_type"})})
public class PointsmallItemRelAttributes {
