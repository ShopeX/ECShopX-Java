...
/** 导购店铺排名 */
@Data
@MpTable(value = "salesperson_leaderboard_distributor", comment = "导购店铺排名", indexes = {@MpIndex(name = "idx_company_distributor", columns = {"company_id", "distributor_id"})})
public class LeaderboardDistributor {
