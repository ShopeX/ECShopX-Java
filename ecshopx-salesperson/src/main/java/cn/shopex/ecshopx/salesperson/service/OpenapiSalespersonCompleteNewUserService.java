...
@Service
public class OpenapiSalespersonCompleteNewUserService {
	...
	public OpenapiSalespersonCompleteNewUserService(
	...
	public void completeNewUser(long companyId, long salespersonId, long userId) {
		...
		SalespersonTask task =
				salespersonTaskMapper.selectActiveTaskForDistributor(
						companyId, distributorId, TASK_TYPE_NEWUSER, now);
