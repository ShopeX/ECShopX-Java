...
/** 导购任务表 */
@Data
@MpTable(value = "salesperson_task_record_logs", comment = "导购任务表")
public class SalespersonTaskRecordLogs {
    ...
    /** 任务记录备注 */
    @MpField(value = "remark", columnType = "json_array", nullable = true, comment = "任务记录备注")
