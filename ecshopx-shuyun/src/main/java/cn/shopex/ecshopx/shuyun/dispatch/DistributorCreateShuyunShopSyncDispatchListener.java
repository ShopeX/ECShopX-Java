...
@Component
public class DistributorCreateShuyunShopSyncDispatchListener implements DispatchListener {

	private final ShopSyncDispatchService shopSyncDispatchService;

	public DistributorCreateShuyunShopSyncDispatchListener(ShopSyncDispatchService shopSyncDispatchService) {
