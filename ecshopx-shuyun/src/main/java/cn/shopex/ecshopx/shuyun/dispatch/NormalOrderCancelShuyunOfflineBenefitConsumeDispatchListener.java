...
@Component
public class NormalOrderCancelShuyunOfflineBenefitConsumeDispatchListener implements DispatchListener {

	private final OfflineBenefitConsumePushService consumePushService;

	public NormalOrderCancelShuyunOfflineBenefitConsumeDispatchListener(
	...
	public void onEvent(Map<String, Object> payload) {
		...
		consumePushService.handleOrderCancel(companyId, orderId);
	}
