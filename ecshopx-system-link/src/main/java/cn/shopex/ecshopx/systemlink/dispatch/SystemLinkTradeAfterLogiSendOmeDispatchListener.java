...
@Component
public class SystemLinkTradeAfterLogiSendOmeDispatchListener implements DispatchListener {

	private final TradeAfterLogiSendOmeNotificationProcessor processor;

	public SystemLinkTradeAfterLogiSendOmeDispatchListener(TradeAfterLogiSendOmeNotificationProcessor processor) {
