...
@Component
public class SystemLinkWdtErpTradeAfterSaleDispatchListener implements DispatchListener {

	private final WdtErpTradeAfterSaleNotificationProcessor processor;

	public SystemLinkWdtErpTradeAfterSaleDispatchListener(WdtErpTradeAfterSaleNotificationProcessor processor) {
