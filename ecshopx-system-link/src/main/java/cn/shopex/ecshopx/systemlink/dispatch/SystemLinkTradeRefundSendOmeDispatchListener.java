...
@Component
public class SystemLinkTradeRefundSendOmeDispatchListener implements DispatchListener {

	private final TradeRefundSendOmeNotificationProcessor processor;

	public SystemLinkTradeRefundSendOmeDispatchListener(TradeRefundSendOmeNotificationProcessor processor) {
