...
/** 内购活动会员累计使用额度 */
@Data
@MpTable(value = "employee_purchase_member_activity_aggregate", comment = "内购活动会员累计使用额度", indexes = {@MpIndex(name = "idx_company_id", columns = {"company_id"})})
public class MemberActivityAggregate {
