...
import cn.shopex.ecshopx.employeepurchase.dispatch.EmployeePurchaseActivityQrcodeExportDispatchPublisher;
...
@Service
public class EmployeePurchaseActivityQrcodeExportFacadeService {

	private final EmployeePurchaseActivityQrcodeCsvExportService csvExportService;
	private final EmployeePurchaseActivityQrcodeExportDispatchPublisher dispatchPublisher;

	public EmployeePurchaseActivityQrcodeExportFacadeService(
			EmployeePurchaseActivityQrcodeCsvExportService csvExportService,
			EmployeePurchaseActivityQrcodeExportDispatchPublisher dispatchPublisher) {
