 ...
 */
@Data
@MpTable(value = "community_chief_distributor", comment = "社区拼团团长关联店铺表", indexes = {@MpIndex(name = "ix_chief_id", columns = {"chief_id"}), @MpIndex(name = "ix_distributor_id", columns = {"distributor_id"})})
public class CommunityChiefDistributor {
