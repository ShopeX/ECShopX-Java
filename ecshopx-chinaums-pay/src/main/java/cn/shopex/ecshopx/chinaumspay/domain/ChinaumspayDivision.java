 ...
 */
@Data
@MpTable(value = "chinaumspay_division", comment = "银联商务支付分账流水", indexes = {@MpIndex(name = "idx_company", columns = {"company_id"}), @MpIndex(name = "idx_distributor_id", columns = {"distributor_id"})})
public class ChinaumspayDivision {
    ...
    /** 回盘成功金额，以分为单位 */
    @MpField("backsucc_fee")
    private Integer backsuccFee;
