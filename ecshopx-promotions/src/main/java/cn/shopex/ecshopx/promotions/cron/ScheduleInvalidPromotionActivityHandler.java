...
public class ScheduleInvalidPromotionActivityHandler {

	private static final String HANDLER_SHORT_NAME = "invalid-promotion-activity";
	...
	public void execute() {
		...
		try {
			int updated = promotionActivityService.activityInvalid();
			log.info(
