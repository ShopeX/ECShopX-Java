...
@Service
public class CreateMemberSuccessSendMembercardExecutionService {

	private final RegisterPromotionsMembercardPromotionService registerPromotionsMembercardPromotionService;

	public CreateMemberSuccessSendMembercardExecutionService(
	...
	public void afterMemberCreateSendMembercard(long companyId, long userId, String mobile) {
		registerPromotionsMembercardPromotionService.executeMembercardRegisterPromotionAfterMemberCreate(
				companyId, userId, mobile);
	}
}
