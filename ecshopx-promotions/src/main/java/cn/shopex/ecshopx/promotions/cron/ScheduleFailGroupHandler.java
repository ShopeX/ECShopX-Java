...
public class ScheduleFailGroupHandler {

	private static final String HANDLER_SHORT_NAME = "fail-group";
	...
	public void execute() {
		...
		try {
			int processed = promotionGroupsTeamAutoCancelService.scheduleAutoCancelGroupOrders();
			log.info(
