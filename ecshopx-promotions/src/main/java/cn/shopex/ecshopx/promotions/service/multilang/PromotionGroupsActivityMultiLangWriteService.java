...
@Service
public class PromotionGroupsActivityMultiLangWriteService {

	private static final String TABLE_AND_MODULE = "promotions_point_upvaluation";
	private static final List<String> FIELDS = List.of("act_name", "pics", "share_desc");
	private static final Pattern SAFE_LANG_SUFFIX = Pattern.compile("^[a-zA-Z0-9]+$");

	private final JdbcTemplate jdbcTemplate;

	public PromotionGroupsActivityMultiLangWriteService(JdbcTemplate jdbcTemplate) {
		this.jdbcTemplate = jdbcTemplate;
	}

	public static String resolveItemMultiLangTableSuffix(String requestLangTag) {
	...
	public void addForNewGroup(
			long groupsActivityId, long companyId, Map<String, Object> requestData, String requestLangTag) {
		if (groupsActivityId <= 0) {
			return;
		}
		String suffix = resolveItemMultiLangTableSuffix(requestLangTag);
