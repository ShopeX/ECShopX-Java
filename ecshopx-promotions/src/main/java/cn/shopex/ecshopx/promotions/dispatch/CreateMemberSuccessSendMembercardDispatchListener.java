...
@Component
public class CreateMemberSuccessSendMembercardDispatchListener implements DispatchListener {

	private final CreateMemberSuccessSendMembercardExecutionService executionService;

	public CreateMemberSuccessSendMembercardDispatchListener(
			CreateMemberSuccessSendMembercardExecutionService executionService) {
	...
	public void onEvent(Map<String, Object> payload) {
		...
		if (rawCompany == null || rawUser == null || rawMobile == null) {
			throw new BadRequestException("company_id, user_id and mobile are required");
		}
		String mobile =
		...
		executionService.afterMemberCreateSendMembercard(companyId, userId, mobile);
	}
}
