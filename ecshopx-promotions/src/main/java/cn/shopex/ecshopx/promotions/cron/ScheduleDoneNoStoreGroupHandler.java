...
public class ScheduleDoneNoStoreGroupHandler {

	private static final String HANDLER_SHORT_NAME = "done-nostore-group";

	private final PromotionGroupsTeamService promotionGroupsTeamService;
	...
	public void execute() {
		...
		try {
			...
			log.info(
					"[cron][{}] done, processed={}, cost={}ms",
					HANDLER_SHORT_NAME, processed, System.currentTimeMillis() - start);
		} catch (Exception e) {
			log.error(
					"[cron][{}] failed, cost={}ms",
