...
@Service
public class BargainPromotionMultiLangWriteService {

	private static final String MODULE_TABLE = "promotions_bargain";
	private static final List<String> FIELDS = List.of("title", "ad_pic");
	private static final Pattern SAFE_LANG_SUFFIX = Pattern.compile("^[a-zA-Z0-9]+$");

	private final JdbcTemplate jdbcTemplate;

	public BargainPromotionMultiLangWriteService(JdbcTemplate jdbcTemplate) {
		this.jdbcTemplate = jdbcTemplate;
	}

	public void addForNewBargain(long bargainId, long companyId, Map<String, Object> data, String requestLangTag) {
		if (bargainId <= 0) {
			return;
		}
