...
@Service
public class LimitPromotionMultiLangWriteService {

	private static final String MODULE_TABLE = "promotions_limit";
	private static final List<String> FIELDS = List.of("limit_name");
	private static final Pattern SAFE_LANG_SUFFIX = Pattern.compile("^[a-zA-Z0-9]+$");

	private final JdbcTemplate jdbcTemplate;

	public LimitPromotionMultiLangWriteService(JdbcTemplate jdbcTemplate) {
		this.jdbcTemplate = jdbcTemplate;
	}

	public void addForNewLimit(long limitId, long companyId, Map<String, Object> data, String requestLangTag) {
		if (limitId <= 0) {
			return;
		}
