...
@Service
public class RegisterPromotionMultiLangWriteService {

	private static final String TABLE_AND_MODULE = "register_promotions";
	private static final List<String> FIELDS = List.of("ad_title", "ad_pic");
	private static final Pattern SAFE_LANG_SUFFIX = Pattern.compile("^[a-zA-Z0-9]+$");

	private final JdbcTemplate jdbcTemplate;

	public RegisterPromotionMultiLangWriteService(JdbcTemplate jdbcTemplate) {
		this.jdbcTemplate = jdbcTemplate;
	}

	public void upsertAdFields(long registerId, long companyId, Map<String, Object> data, String requestLangTag) {
		if (registerId <= 0) {
			return;
		}
