...
@Data
@MpTable(
		value = "promotions_turntable_user_day_count",
		comment = "大转盘用户每日次数",
		uniqueIndexes = {
			@MpIndex(
					name = "uk_turntable_user_day_count",
					columns = {"company_id", "user_id", "act_id", "day_key"})
		})
public class TurntableUserDayCount {
	...
	@MpField(value = "day_count", columnType = "bigint", comment = "当日已占用次数")
