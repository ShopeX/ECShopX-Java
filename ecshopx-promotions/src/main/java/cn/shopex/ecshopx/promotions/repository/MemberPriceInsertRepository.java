...
@Repository
public class MemberPriceInsertRepository {

	private final MemberPriceMapper memberPriceMapper;

	public MemberPriceInsertRepository(MemberPriceMapper memberPriceMapper) {
		this.memberPriceMapper = memberPriceMapper;
	}

	public int insert(MemberPrice entity) {
		return memberPriceMapper.insert(entity);
	}
}
