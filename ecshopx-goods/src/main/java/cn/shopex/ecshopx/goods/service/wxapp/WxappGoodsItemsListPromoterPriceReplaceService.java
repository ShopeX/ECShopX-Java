...
@Service
public class WxappGoodsItemsListPromoterPriceReplaceService {

	@SuppressWarnings("unchecked")
	public void replacePrices(long companyId, List<Map<String, Object>> rows, Map<String, Object> popularizeConfigSlice) {
		...
		for (Map<String, Object> itemInfo : rows) {
