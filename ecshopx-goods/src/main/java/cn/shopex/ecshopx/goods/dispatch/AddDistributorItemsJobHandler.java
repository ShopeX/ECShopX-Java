...
@Component
public class AddDistributorItemsJobHandler implements DispatchHandler {

	private final DistributorItemsPagedAddRunner pagedAddRunner;

	public AddDistributorItemsJobHandler(DistributorItemsPagedAddRunner pagedAddRunner) {
		this.pagedAddRunner = pagedAddRunner;
	}

	@Override
	public void handle(Map<String, Object> payload) {
		pagedAddRunner.consumeOneQueuedPage(payload);
	}
}
