...
@Component
public class SupplierGoodsEspierImportRowSink implements EspierImportRowSink {

	private final SupplierGoodsImportRowOrchestrator supplierGoodsImportRowOrchestrator;

	public SupplierGoodsEspierImportRowSink(SupplierGoodsImportRowOrchestrator supplierGoodsImportRowOrchestrator) {
	...
	public void acceptRow(
		...
		supplierGoodsImportRowOrchestrator.acceptRow(companyId, supplierId, distributorId, row);
	}
}
