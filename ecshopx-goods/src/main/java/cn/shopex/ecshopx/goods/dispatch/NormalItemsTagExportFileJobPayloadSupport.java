...
public final class NormalItemsTagExportFileJobPayloadSupport {

	private NormalItemsTagExportFileJobPayloadSupport() {}

	public static NormalItemsTagExportContext contextFromPayload(Map<String, Object> payload) {
		...
		return new NormalItemsTagExportContext(companyId, operatorId, operatorType, merchantId, filterParams);
	}
