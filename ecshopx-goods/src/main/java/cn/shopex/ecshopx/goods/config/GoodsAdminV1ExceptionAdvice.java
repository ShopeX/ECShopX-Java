...
@RestControllerAdvice(basePackages = "cn.shopex.ecshopx.goods.api.admin.v1")
@Order(Ordered.HIGHEST_PRECEDENCE)
public class GoodsAdminV1ExceptionAdvice {

	@ExceptionHandler({BadRequestException.class, ResourceException.class})
	public ResponseEntity<Map<String, Object>> handleGoodsAdminBusinessErrors(RuntimeException ex) {
