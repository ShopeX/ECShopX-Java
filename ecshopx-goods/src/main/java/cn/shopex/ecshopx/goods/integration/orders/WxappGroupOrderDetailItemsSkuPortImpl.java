...
import cn.shopex.ecshopx.common.goods.port.WxappGroupOrderDetailItemsSkuPort;
import cn.shopex.ecshopx.goods.service.items.EmployeePurchaseItemsSkuDetailService;
import java.util.Map;
import org.springframework.stereotype.Service;

@Service
public class WxappGroupOrderDetailItemsSkuPortImpl implements WxappGroupOrderDetailItemsSkuPort {

	private final EmployeePurchaseItemsSkuDetailService employeePurchaseItemsSkuDetailService;

	public WxappGroupOrderDetailItemsSkuPortImpl(
	...
	@Override
	public Map<String, Object> loadItemsSkuDetail(long companyId, long itemId) {
		return employeePurchaseItemsSkuDetailService.loadSkuDetailMap(companyId, itemId);
	}
}
