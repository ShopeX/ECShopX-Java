...
/**
 * Admin entry point for enqueueing the first-page brand sync job for a company.
 ...
 */
@Service
public class OmeBrandSyncFacade {

	private final GetBrandFromOmeJobDispatchPublisher getBrandFromOmeJobDispatchPublisher;

	public OmeBrandSyncFacade(GetBrandFromOmeJobDispatchPublisher getBrandFromOmeJobDispatchPublisher) {
		this.getBrandFromOmeJobDispatchPublisher = getBrandFromOmeJobDispatchPublisher;
	}

	/**
	 * Enqueues the initial brand-from-OME job for the given tenant.
	 *
	...
	public void enqueueInitialSync(long companyId) {
		...
		getBrandFromOmeJobDispatchPublisher.enqueueGetBrandFromOme(companyId, 1, endUnix);
	}
}
