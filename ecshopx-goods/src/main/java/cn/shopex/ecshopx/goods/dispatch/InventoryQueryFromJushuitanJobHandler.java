...
@Component
public class InventoryQueryFromJushuitanJobHandler implements DispatchHandler {

	private final JushuitanInventoryQueryBatchHandler batchHandler;

	public InventoryQueryFromJushuitanJobHandler(JushuitanInventoryQueryBatchHandler batchHandler) {
	...
	public void handle(Map<String, Object> payload) {
		...
		batchHandler.handleBatches(companyId, itemIds);
	}
