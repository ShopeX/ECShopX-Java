...
@Service
public class GoodsSuperadminRoutePermissionService {

	public static final String ROUTE_ALIAS_GOODS_ITEMS_CREATE = "goods.items.create";

	public static final String ROUTE_ALIAS_GOODS_ITEMS_AUDIT = "goods.items.audit";

	public static final String ROUTE_ALIAS_GOODS_ITEMS_DELETE = "goods.items.delete";
	...
	public GoodsSuperadminRoutePermissionService(
	...
	public void assertCanCreateItems(Map<String, Object> user, String routeAlias) {
	...
	public void assertCanAuditItems(Map<String, Object> user) {
		assertCanCreateItems(user, ROUTE_ALIAS_GOODS_ITEMS_AUDIT);
	}
