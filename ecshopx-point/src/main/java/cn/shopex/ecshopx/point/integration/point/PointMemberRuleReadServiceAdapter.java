...
package cn.shopex.ecshopx.point.integration.point;
...
@Service
@Profile("!test-cron")
public class PointMemberRuleReadServiceAdapter implements PointMemberRuleReadPort {

	private final PointMemberRuleReadService pointMemberRuleReadService;

	public PointMemberRuleReadServiceAdapter(PointMemberRuleReadService pointMemberRuleReadService) {
