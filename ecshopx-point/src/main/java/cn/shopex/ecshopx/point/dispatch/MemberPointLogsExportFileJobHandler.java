...
@Component
public class MemberPointLogsExportFileJobHandler {

	private final PointMemberLogCsvExportService pointMemberLogCsvExportService;

	public MemberPointLogsExportFileJobHandler(PointMemberLogCsvExportService pointMemberLogCsvExportService) {
		this.pointMemberLogCsvExportService = pointMemberLogCsvExportService;
	}

	public void run(PointMemberLogExportContext ctx) {
