...
@Component
public class SendMemberPointJobHandler implements DispatchHandler {

	private final PointMemberService pointMemberService;

	public SendMemberPointJobHandler(PointMemberService pointMemberService) {
		this.pointMemberService = pointMemberService;
	}
