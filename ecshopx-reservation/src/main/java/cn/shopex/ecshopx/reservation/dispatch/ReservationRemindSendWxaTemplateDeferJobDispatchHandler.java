...
@Component
public class ReservationRemindSendWxaTemplateDeferJobDispatchHandler implements DispatchHandler {

	private final ReservationRemindSendWxaTemplateDispatchService reservationRemindSendWxaTemplateDispatchService;

	public ReservationRemindSendWxaTemplateDeferJobDispatchHandler(
